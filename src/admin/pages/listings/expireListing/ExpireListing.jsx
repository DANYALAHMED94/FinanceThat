...
import DealerExpireListing from "../../../component/listings/expireListings/DealerExpireListing";
import PrivateExpireListing from "../../../component/listings/expireListings/PrivateExpireListing";
import {
  get_listing,
...
class ExpireListing extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tab: "dealer",
