...
const DealerPendingListing = (props) => {
  ...
  const componentRefPendingDeleteListing = React.useRef(null);
  ...
  (props.listing_detail || []).map((item, index) =>
    exportData.push({
      vehicle: `${item.year || ""} | ${item.make !== undefined && item.make !== null
  ...
  const archiveListing = () => {
    ...
    // props.soft_delete_single_listing(data)
  };
  const delete_single_listing = (id) => {
    props.soft_delete_single_listing(id, "Search Pending Listing");
  };
  const delete_multiple_listing = () => {
    ...
    props.soft_delete_listings(ids, "Search Pending Listing");
  };
  const reactToPrintContent = React.useCallback(() => {
    return componentRefPendingDeleteListing.current;
  }, [componentRefPendingDeleteListing.current]);
      ...
      <div className="Altable-Container">
        <div className="AlContainer" style={{ padding: "20px 12px 0px", margin: "0px" }} >
          <div className="row">
            <div className="col-sm-4">
              <div className="input-group" style={{ margin: "2px 0px 0px 0px" }}>
                {/* <input type="text" id="search" name="search" class="form-control border-end-0 customsearch" placeholder="Search Applications" value="" />
        ...
        <div className="Admin-dtable" style={{ margin: "20px 0px 0px 0px" }}>
          <table
            style={{ width: "100%" }}
            id=""
            ref={componentRefPendingDeleteListing}
          >
            <thead>
              <tr>
                <th>
                ...
                <th>
                  <div className="imgprint">
                    ...
                    <ReactToPrint
                      documentTitle="Pending Listing Dealer Record"
...
export default DealerPendingListing;
