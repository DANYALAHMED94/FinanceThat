...
class LoanPaymentDetail extends Component {
  ...
  update_loadPayment_detail = () => {
    ...
    if(this.props.loanFirstPaymentDate){
      data.loan.first_payment_date= moment(this.props.loanFirstPaymentDate).format("YYYY-MM-DD");
    }
    console.log(data);
        ...
        <div className="app-form-content">
          ...
          <div className="form-main">
            ...
            <Link to={`${this.props.url}/income-verify`}>
              ...
              {/* <button className="btn btn-primary float-right active" onClick={this.update_loadPayment_detail} > Continue  </button> */}
