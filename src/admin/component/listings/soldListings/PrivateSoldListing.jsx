...
const PrivateSoldListing = (props) => {
  ...
  const componentRefSoldDeleteListing = React.useRef(null);
  ...
  const delete_single_listing = (id) => {
    props.soft_delete_single_listing(id, "Search Sold Listing");
  };
  const delete_multiple_listing = () => {
    ...
    props.soft_delete_listings(ids, "Search Sold Listing");
  };
  const reactToPrintContent = React.useCallback(() => {
    return componentRefSoldDeleteListing.current;
  }, [componentRefSoldDeleteListing.current]);
      ...
      <div className="Altable-Container">
        <div className="Admin-dtable">
          ...
          <table
            style={{ width: "100%" }}
            id=""
            ref={componentRefSoldDeleteListing}
          >
            <thead>
              <tr>
                <th>
                  ...
                  <div className="imgprint">
                    ...
                    >
                      <CSVLink
                        data={exportData}
                        headers={headers}
                        filename={"Sold_Private_Listings.csv"}
                      >
                        <img
                    ...
                    <ReactToPrint
                      documentTitle="Sold Listing Seller Record"
...
export default PrivateSoldListing;
