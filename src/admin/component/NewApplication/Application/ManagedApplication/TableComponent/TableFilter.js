...
const TableFilter = ({ search, setSearchParams, searchParams, setChangeSelect, changeSelect, setSearch }) => {
    ...
    return (<>
        ...
        <div className="row">
            ...
            <div className="col-sm-2 selectdropdown">
                <MultiSelectDropDown dataOptions={[...createdBy_options, {label:"Manager",value:"manager"},{label:"Admin",value:"admin"},{label:"Agent",value:"agent"}]} selectedValue={applicationCreatedBy}
