...
const DealerAdminNewAccount = props => {
        ...
        <React.Fragment>
            <div className="NewApp-Container">
                ...
                <div className="ViewAll-Btn">
                    <Link to={`/dealer-admin/pending-account`}>View all accounts</Link>
                </div>
...
export default DealerAdminNewAccount