...
import { retailPurchase } from "../constant";
import { Formik, Form, Field } from "formik";
import { SelectInput } from "../formInputs";
import * as Yup from "yup";
export default function RetailPurchase({ formState, setFormState, onContinue }) {
  ...
  return (
    ...
    <h1>Please select an option for Retail Purchase</h1>
    <Formik
      initialValues={{
    ...
    >
      <Form>
        ...
        <Field
              ...
              placeholder="Retail Purchase"
              options={retailPurchase}
            />
        </div>
