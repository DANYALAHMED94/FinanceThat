...
import { vehicleImages, subVehicleImages, subVehicleImagesCon } from './vehicleImages';
...
const TypeofVehicle = (props) => {
    ...
    const sub_type_of_vehicle_con = (props.type_of_vehicles || []).map((item, index) => (
        item.name.toUpperCase() === ('Construction').toUpperCase() || item.name.toUpperCase() === ('Constructions').toUpperCase() ? (item.typeofvehicle_id || []).map((subItem, subIndex) => (
            <React.Fragment key={subIndex}>
                <div className="boxed-grid-col">
                    <div className="addPostBox" key={subIndex}  >
                        <label className="AdPost-CheckBox">
    ...
    let typeName = props.type_of_vehicles.filter(item => Number(item.id) === Number(props.state.typeOfVehicle)).map(item => { return item.name })[0]
    ...
    const vehcile_mokes = props.state.selectedTypeName.toUpperCase() === ('Automotive').toUpperCase() ? (props.vehicle_makes || []).map((item, index) => (
        <React.Fragment key={index}>
            ...
            {item.image_path ? (<div className="boxed-grid-col" key={index} style={{ minHeight: '96.81px' }}>
                <div className={Number(props.state.selectVehicleMake) === Number(item.id) ? "SelectCar-Brand active" : "SelectCar-Brand"} onClick={() => props.handleOnClick('selectVehicleMake', item.id)} style={{ minHeight: '70.81px' }}>
    ...
    const boatBackFuel = props.state.selectedTypeName.toUpperCase() === ('Construction').toUpperCase() ? 10  :props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 11 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 7 : props.state.selectedTypeName.toUpperCase() === ('RV').toUpperCase() ? 7.1 : 14
    const boatNextOwner = props.state.selectedTypeName.toUpperCase() === ('Construction').toUpperCase() ? 18 : props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 17 : props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase() ? 16 : 16
    const boatBackOwner = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 15 : 16
    const backSubType = props.state.selectedTypeName.toUpperCase() === ('Construction').toUpperCase() ? 15 :props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase() ? 15 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() || props.state.selectedTypeName.toUpperCase() === ('Trailer').toUpperCase() ? 16 : 17
    const transmissionNext = props.state.selectedTypeName.toUpperCase() === ('Construction').toUpperCase() ? 15 :(props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase()) ? 14 : 11
    const transmissionPrev = props.state.selectedTypeName.toUpperCase() === ('Construction').toUpperCase() ? 7 :(props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase()) ? 7 : 9
            ...
            {Number(props.state.step) === 17 ? (
                <Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
                    <div className="AdPost-SecThree item" id="features">
                        ...
                        <div className="row">
                            {(props.vehicle_features || []).map((item, index) => (
                                <React.Fragment key={index}>
            ...
            {props.state.engineStepName !== '' && props.state.engineStepName !== undefined && props.state.newStep === true && Number(props.state.step) === 1.3 ? (
                <Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
                    <div className="AdPost-SecFifteen vin-hin-section">
                        ...
                        {/* {props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? (<div className="post-ad-tabular-filter-row EnginInput">
                            <label>Engin Hours</label>
                            <div className="form-group">
                                <input
                                    className="form-control"
                                    type="text"
                                    id={'enginHours'}
                                    name={'enginHours'}
                                    value={props.state.enginHours}
                                    onChange={props.handleOnChange}
                                    placeholder='Engin Hours'
                                />
                            </div>
                        </div>) : null} */}
                    ...
                    <>
                        ...
                        <Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
                            <div className="AdPost-SecOne item" id="type_of_vehicles">
                                <h6>Select type of {(props.type_of_vehicles|| []).filter(item=> Number(item.id) === Number(props.state.typeOfVehicle))?.[0]?.name || ""} Vehicle:</h6>
                                <div className="boxed-grid-main clearfix">
                                    {/* {type_of_vehicle} */}
                                    {typeName === "Construction"  ? sub_type_of_vehicle_con :sub_type_of_vehicle }
                                    {/* Sub Type */}
                                </div>
                                <div className='row align-items-center'>
                                    <div className='col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6'>
