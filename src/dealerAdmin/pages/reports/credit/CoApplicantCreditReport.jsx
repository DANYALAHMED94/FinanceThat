...
import {
    get_co_applicant_credit_details
...
class CoApplicantCreditReport extends Component {
    constructor(props) {
        super(props);
        this.state = {
            credit_detail: []
    ...
    componentDidMount() {
        ...
        this.props.get_co_applicant_credit_details(id)
    }
    componentDidUpdate(prevProps, prevState) {
        if (prevProps.co_applicant_credit_report !== this.props.co_applicant_credit_report && this.props.co_applicant_credit_report) {
            this.setState({
                ...this.state,
                credit_detail: this.props.co_applicant_credit_report
            })
        }
    }
    render() {
        ...
        return (
            <React.Fragment>
                <Helmet>
                    <title>Co Applicant Credit Report</title>
                ...
                <div class="TradeAcc-Container">
                    ...
                    {this.state.credit_detail ? this.state.credit_detail.trades ? (this.state.credit_detail.trades || []).map(item => (
                        <>
                           ...
                           <div class="clearfix"></div>
                           <li>
                              <h2>At least 120 days past due</h2>
                           </li>
                           <li>
                              <h3>2018-03</h3>
                           </li> */}
...
const mapStateToProps = (state) => {
    return {
        co_applicant_credit_report: state.adminReducer.adminAccounts.applicationReducer.co_applicant_credit_report,
    }
}
