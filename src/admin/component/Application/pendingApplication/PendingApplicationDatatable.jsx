...
const PendingApplicationDatatable = (props) => {
  ...
  const delete_application = (id) => {
    props.delete_single_row(id, "Search Pending Applications");
  };
  const delete_application_multi = () => {
    ...
    props.delete_multi_row(ids, "Search Pending Applications");
  };
...
export default PendingApplicationDatatable;
