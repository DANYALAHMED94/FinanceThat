...
const PersonalHomeLazyLoading = () => {
    const onClickGetStarted = () => {
        scroller.scrollTo("personal__loanFormWrapper", {
            duration: 800,
            delay: 0,
                ...
                <div className="row">
                  <div className="col-md-6 order-2 order-md-1">
                    ...
                    <img src='/public/assets/p-img/icon-emergency-expenses.svg' alt=''/>
                        ...
                        <h4 style={{fontFamily:"BasisGrotesquePro-Medium"}}>We offer personal loans that range from $500 up to $20,000. Rates starting from 29.99%</h4>
    ...
    <img style={{position:"absolute",marginTop:"3px",marginLeft:"44px",width:"28px"}} src="/assets/p-img/icon-arrow-right.svg" alt=""/>
        ...
        <section className='personal__loanFormWrapper'>
            <div className="section__container">
                ...
                <section className="postAppQuick" style={{padding:"0", backgroundColor:'#ffff'}}>
      <div className="formDiv" style={{padding:"0"}}>
        <div className="innerDiv">
          ...
          <div className='personal-loan-loader'>
          <i
...
export default PersonalHomeLazyLoading