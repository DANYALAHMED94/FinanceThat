...
import TradeIn from "../../component/Application/TradeIn";
...
import {get_credit_details, remove_credit_details} from '../../../actions/admin/applicationActions'
import {
    get_addtional_type,
  get_vehicle_make,
...
class EditDealerAdminApplication extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      loanInterestRate: "",
      loanAmountFinanced: "",
      loanFrequencyPayment: "",
      terms: [{ value: 36, label: "36 months" }, { value: 48, label: "48 months" }, { value: 60, label: "60 months" }, { value: 72, label: "72 months" }, { value: 84, label: "84 months" }, { value: 96, label: "96 months" }, { value: 108, label: "108 months" }, { value: 120, label: "120 months" }],
      // Co Applicant
      coApplicant: false,
      coApplicantId: "",
      ...
      postApp: [
        ...
        },
        {
          ...
          pending: false,
          path: `${this.props.match.url}/trade-in`,
        },
        {
          id: 5,
  ...
  componentDidMount() {
    // this.props.get_flinks_images('https://netverify.com/api/netverify/v2/scans/4a663d16-d126-4fda-a2e2-c50c6e3e5e03/images/face')
    ...
    if (
      ...
      this.props.get_credit_details(this.props.match.params.id)
  ...
  changeSelectAssets = (e, formName, name, index) => {
    this.setState({
      ...
      assetsDetailsForm: this.state.assetsDetailsForm
        ...
        firstTypeOfVehicle:name === "selectedVehicle" ? this?.state?.assetsDetails?.length > 1 ? this?.state?.assetsDetails?.[0]?.selectedVehicle?.label || "" : e?.label || "" : this.state.firstTypeOfVehicle
    });
  };
  changeSelectAssetTonnage = (e) => {
    this.setState({
      ...this.state,
      selectedTonnage:e.target.value
    })
  };
  ...
  handleOnChangeAssetsClientBudget = (e) => {
    this.setState({
      client_budgetshow: e,
      client_budget: e.label
    });
  };
  addAssets = () => {
    this.setState({
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      ...
      let firstTypeOfVehicle = this.props.application_detail
        ? this.props.application_detail.vehicle &&
          ...
          : ""
        : "";
       const client_budget =  this.props.application_detail != undefined &&
          this.props.application_detail != null
          ? this.props.application_detail.monthly_budget != undefined &&
            this.props.application_detail.monthly_budget != null
            ? this.props.application_detail.monthly_budget
            : 0
          : 0;
      this.setState({
        ...this.state,
        ...
        firstTypeOfVehicle:
          firstTypeOfVehicle && firstTypeOfVehicle.length > 0
            ...
            : "",
            monthly_budget:this.props.application_detail?.monthly_budget || "",
            selectedMonthlyBudget:this.state.clientBudgetOptions?.filter(item=> item.value === this.props.application_detail?.monthly_budget || "")?.[0] || "",
        assetsDetails: this.props.application_detail
          ? this.props.application_detail.vehicle !== undefined &&
            ...
            ? (this.props.application_detail.vehicle || []).map((item) => {
              return {
                ...item,
                sub_type_of_vehicle: item.sub_type_of_vehicle !== undefined &&
                item.sub_type_of_vehicle !== null
                ? item.sub_type_of_vehicle
                : "",
              selectedSubTypeOfVehicle:
              item.type_of_vehicle !== undefined &&
                  ...
                  ? (typeOfVehicle || []).filter(
                    ...
                    ? (typeOfVehicle || []).filter(
                      ...
                      (subIt?.sub_type_of_vehicle || [])?.filter(ite=>
                        (Number(ite.id) === Number(item.sub_type_of_vehicle))
                     )?.map(itee=> {return {value:itee.id, label:itee.name}})?.[0] || ""
                    ))?.[0] || ""
                    : ""
                  : "",
                body_type: item.body_type !== undefined &&
                  item.body_type !== null
                  ? item.body_type
                  : "",
                engine: item.engine !== undefined &&
                  ...
                  ? item.engine
                  : "",
                tonnage: item.tonnage !== undefined &&
                  item.tonnage !== null
                  ? item.tonnage
                  : "",
                selectedTonnage: item?.tonnage,
                ...
                selectedCondition: item.condition
                  ...
                  : "",
                selectedTradeIn: (this.state.tradeIns || []).filter(ite => ite.value === item?.trade_in)?.[0] || '',
                tradeIn: item?.trade_in,
                client_budget: item?.client_budget || client_budget,
                is_updated: true,
                new: false,
              };
            })
    ...
    if (
      ...
      application_type:this.props.application_detail?.application_type,
        ...
        trade_in: this.props.application_detail?.trade_in || "",
        trade_in_complete: this.props.application_detail?.trade_in_complete,
        tradeYear: this.props.application_detail?.trade
          ?.year || "",
        tradeMake: this.props.application_detail?.trade
          ?.make || "",
        tradeModel: this.props.application_detail?.trade
          ?.model || "",
        tradeTrim: this.props.application_detail?.trade
          ?.trim || "",
        tradeKilometer: this.props.application_detail?.trade
          ?.kilometer || "",
        tradeVin: this.props.application_detail?.trade
          ?.vin || "",
        tradeAllowance: this.props.application_detail?.trade
          ?.allowance || "",
        tradeCondition: this.props.application_detail?.trade
          ?.condition || "",
        selectedTradeCondition: this.props.application_detail?.trade
          ?.condition
          ? {
            value: this.props.application_detail?.trade
              ?.condition, label: this.props.application_detail?.trade
                ?.condition
          }
          : "",
        loanCashPrice: this.props.application_detail?.loan
          ?.cash_price || "",
        loanTaxes: this.props.application_detail?.loan
          ?.taxes || "",
        loanDownPayment: this.props.application_detail?.loan
          ?.down_payment || "",
        loanDealerAdminFee: this.props.application_detail?.loan
          ?.dealer_admin_fee || "",
        loanLicenseFee: this.props.application_detail?.loan
          ?.lincense_fee || "",
        loanExtendedWarranty: this.props.application_detail?.loan
          ?.extended_warranty || "",
        loanGapInsurance: this.props.application_detail?.loan
          ?.gap_insurance || "",
        loanFirstPaymentDate: this.props.application_detail?.loan
          ?.first_payment_date ? new Date(this.props.application_detail?.loan
            ?.first_payment_date || "") : "",
        loanTerms: this.props.application_detail?.loan
          ?.terms || "",
        selectedLoanTerms: this.state.terms.filter(item => item.value === this.props.application_detail?.loan
          ?.terms)?.[0] || '',
        loanAmortization: this.props.application_detail?.loan
          ?.amortization || "",
        selectedLoanAmortization: {
          value: this.props.application_detail?.loan
            ?.amortization, label: this.props.application_detail?.loan
              ?.amortization
        },
        loanPaymentFrequency: this.props.application_detail?.loan
          ?.payment_frequency || "",
        selectedLoanPaymentFrequency: {
          value: this.props.application_detail?.loan
            ?.payment_frequency, label: this.props.application_detail?.loan
              ?.payment_frequency
        },
        loanInterestRate: this.props.application_detail?.loan
          ?.interest_rate || "",
        loanAmountFinanced: this.props.application_detail?.loan
          ?.amount_financed || "",
        loanFrequencyPayment: this.props.application_detail?.loan
          ?.frequency_payment || "",
        buyerAppId:
          this.props.application_detail.id
            ? this.props.application_detail.id
            : "",
        monthly_budget: this.props.application_detail.monthly_budget !== undefined &&
          this.props.application_detail.monthly_budget !== null
          ? this.props.application_detail.monthly_budget
          : "",
        declineReason:
        ...
        //     )
        //     : "",
        applicantTelephone: this.props.application_detail.telephone !== undefined &&
        this.props.application_detail.telephone !== null
        ? this.props.application_detail?.telephone?.length === 11 ? this.props.application_detail?.telephone?.slice(-10): this.props.application_detail?.telephone?.replace("+1", "").trim()
        : "",
        applicantAddress:
        ...
        previousEmployerCity:
          this.props.application_detail?.previous_employer_address
            ...
            this.props.application_detail?.previous_employer_address
              ?.employer_province,
              selectedPreviousEmployerProvince:this.state.provinces.filter(
                (el) =>
                  el.value ===
                  this.props.application_detail?.previous_employer_address
              ?.employer_province
        ...
        previousSelectedMonthlyGrossIncome:this.state.grossMonthlyIncomeValues.filter(item=> item.value === this.props.application_detail?.previous_employer_address
              ?.gross_income)?.[0] || '',
         previousMonthlyGrossIncome: this.props.application_detail?.previous_employer_address?.gross_income|| '',
        previousGrossIncome:
          this.props.application_detail?.previous_employer_address
            ?.gross_income || 0,
        previousGrossIncomeSlider: this.props.application_detail?.previous_employer_address
          ?.gross_income || 0,
        previousEmployeeBusinessName:
          this.props.application_detail?.previous_employer_address
            ?.business_name,
        ...
        selectedStatus:
          this.props.application_detail.status !== undefined &&
            ...
            : "",
        employmentSince: employmentSince,
        monthlySelectedGrossIncome: this.state.grossMonthlyIncomeValues.filter(item=> item.value === this.props.application_detail?.gross_income)?.[0] || '',
        monthlyGrossIncome:this.props.application_detail?.gross_income,
        grossMonthlyIncome:
          this.props.application_detail.gross_income !== undefined &&
            this.props.application_detail.gross_income !== null
            ? this.props.application_detail.gross_income || 0
            : 0,
        ...
        coApplicantOccupation:
          this.props.application_detail !== undefined &&
            ...
            : "",
        coApplicantEmploymentSince: coApplicantEmploymentSince,
        coApplicantSelectedMonthlyGrossIncome:this.props.application_detail !== undefined &&
        this.props.application_detail !== null
        ? this.props.application_detail.co_applicant !== null &&
          this.props.application_detail.co_applicant !== null
          ? this.props.application_detail.co_applicant.gross_income !==
            ...
            ? this.state.grossMonthlyIncomeValues.filter(item=> item.value === this.props.application_detail.co_applicant.gross_income)?.[0] || '0'
            : ""
          : ""
        : "",
        coApplicantMonthlyGrossIncome:this.props.application_detail !== undefined &&
        this.props.application_detail !== null
        ? this.props.application_detail.co_applicant !== null &&
          this.props.application_detail.co_applicant !== null
          ? this.props.application_detail.co_applicant.gross_income !==
          ...
          this.props.application_detail !== undefined &&
            ...
            ? this.props.application_detail.co_applicant !== null &&
              ...
              ? this.props.application_detail.co_applicant.gross_income !==
                undefined &&
                this.props.application_detail.co_applicant.gross_income !== null
                ? this.props.application_detail.co_applicant.gross_income || 0
                : ""
              : ""
            : "",
        ...
        coApplicantSin:
          this.props.application_detail !== undefined &&
            ...
            ? this.props.application_detail.co_applicant !== null &&
              ...
              : ""
            : "",
            coApplicantEmail:this.props.application_detail !== undefined &&
            this.props.application_detail !== null
            ? this.props.application_detail.co_applicant !== null &&
              this.props.application_detail.co_applicant !== null
              ? this.props.application_detail.co_applicant.email !== undefined &&
                this.props.application_detail.co_applicant.email !== null
                ? this.props.application_detail.co_applicant.email
                : ""
              : ""
            : "",
        coApplicantBusniessName:
        ...
        selectedEmployerProvince:this.state.provinces.filter(
          (el) =>
            el.value ===
            this.props?.application_detail?.employer_province,
        )?.[0] || "",
        employerPhone:
         this.props?.application_detail?.employer_telephone,
        ...
        coEmployerProvince:
          ...
          selectedcoEmployerProvince:this.state.provinces.filter(
            (el) =>
              el.value ===
              this.props?.application_detail?.employer_province,
          )?.[0] || "",
        ...
        applicantEmail:
          this.props.application_detail != undefined &&
            this.props.application_detail != null ? this.props.application_detail?.applicant_email_by_dealer ? this.props.application_detail?.applicant_email_by_dealer
        ...
        coPreviousCountry: this.props.application_detail?.co_applicant
          ?.previous_applicant_address?.country,
        coPreviousProvince:
          this.props.application_detail?.co_applicant
        ...
        previousCoEmploymentSinceMonth:
          this.props.application_detail?.co_applicant?.previous_employer_address
            ?.employment_since_month,
        coApplicantPreviousMonthlyGrossIncome:this.props.application_detail?.co_applicant?.previous_employer_address
            ?.gross_income,
      coApplicantPreviousSelectedMonthlyGrossIncome:this.state.grossMonthlyIncomeValues.filter(item=> item.value === this.props.application_detail?.co_applicant?.previous_employer_address
        ?.gross_income)?.[0] || '',
        previousCoGrossIncome:
          this.props.application_detail?.co_applicant?.previous_employer_address
            ?.gross_income,
        previousDefaultCoGrossIncome:
          this.props.application_detail?.co_applicant?.previous_employer_address
            ?.gross_income || 0,
        previousCoEmployeeBusinessName:
          this.props.application_detail?.co_applicant?.previous_employer_address
        ...
        postApp: this.state.postApp.slice().map((item) => {
          ...
          if (item.id === 3) {
            return {
              ...item,
              disbaled: false,
              done: (this.props.application_detail != undefined &&
                this.props.application_detail != null
          ...
          if (item.id === 4) {
            return {
              ...
              disbaled: false,
                ...
                this.props.application_detail != undefined &&
                  this.props.application_detail != null
                  ? this.props.application_detail.trade_in_complete !=
                    undefined &&
                    this.props.application_detail.trade_in_complete !=
                    null
                    ? this.props.application_detail.trade_in_complete
                    : false
                  : false,
              pending: this.props?.applocation_detail?.trade ? true : false,
            };
          }
          if (item.id === 5) {
            return {
        ...
        assets_complete:
          this.props.application_detail != undefined &&
            ...
            ? this.props.application_detail.assets_complete != undefined &&
              ...
              : false
            : false,
        trade_in_complete: this.props.application_detail != undefined &&
          this.props.application_detail != null
          ? this.props.application_detail.trade_in_complete != undefined &&
            this.props.application_detail.trade_in_complete != null
            ? this.props.application_detail.trade_in_complete
            : false
          : false,
        ...
        assetsDetails = assetsDetails.map((asst, index) => {
          if (Number(index) === Number(this.state.stockIndex)) {
            return {
              ...
              sub_type_of_vehicle: item.sub_type_id !== undefined &&
              item.sub_type_id !== null
              ? item.sub_type_id?.id || ""
              : "",
            selectedSubTypeOfVehicle:
            item.sub_type_id !== undefined &&
              item.sub_type_id !== null
              ? {
                value: item.sub_type_id ? item.sub_type_id.id : "",
    ...
    if (
      prevProps.trade_in_complete_redux !==
      this.props.trade_in_complete_redux
    ) {
      this.setState({
        ...this.state,
        postApp: this.state.postApp.slice().map((item) => {
          if (item.id === 4) {
            return {
              ...item,
              done: this.props.trade_in_complete_redux
                ? this.props.trade_in_complete_redux
                : false,
            };
          }
  ...
  refund_application = (id) => {
    ...
    axios(options)
      .then(async (response) => {
        ...
        this.setState({ changeStatusRefund: 1 })
    ...
    return (
      <React.Fragment>
        ...
        <div className="app-form-main clearfix">
          <Link className="back" to={`${this.state.mainUrl}`}>
            {" "}
            ...
            <div className="side-bar-content">
              <div className="sidebar-head clearfix">
                ...
                <div className="row report-btn py-3">
                  <div class="col-md-6">
                    {/* <span>
                    {this.props.application_detail ? this.props.application_detail.score  ? this.props.application_detail.score : null : null }
                    </span> */}
                  </div>
              ...
              <div className="sidebar-nav-holder">
                ...
                {+this.state.application_type !== 3 ? (this.props?.application_detail?.refund_status == 0 && this.state.changeStatusRefund == 0) ?
                  <div
                    ...
                    onClick={() => {
                      if (this.props?.application_detail?.id) {
                        //H
                        var answer = window.confirm("do you really want to request a refund? ")
                        if (answer) {
                          //some code
                  ...
                  >
                    ...
                    >
                      {" "}
                      {this.state.loadingRefund ? "Loading..." : "Request-Refund"}{" "}
                    </span>{" "}
                  </div>
                  : this.props?.application_detail?.refund_status == 2 ?
                    <div
                      className="Refunded"
                    >
                      {" "}
            ...
            <Route
              ...
              render={(props) => (
                <AssetDetail
                  ...
                  changeSelectAssetTonnage={this.changeSelectAssetTonnage}
                  handleOnChangeAssets={this.handleOnChangeAssets}
                  handleOnChangeAssetsClientBudget={this.handleOnChangeAssetsClientBudget}
            ...
            <Route
              ...
              render={(props) => (
                <VerifyIdentity
                  ...
                  request_identity_verification={this.props.request_identity_verification}
                  buyerAppId={this.state.buyerAppId}
...
const mapStateToProps = (state) => {
  return {
    ...
    loading_update:
      state.dealerAdminReducer.dealerApplicationReducer.loading_update,
    ...
    updateCoBuyerApplicationEmployement:
      state.dealerAdminReducer.dealerApplicationReducer
        .updateCoBuyerApplicationEmployement,
    updateAssetsDetail:
      state.dealerAdminReducer.dealerApplicationReducer.updateAssetsDetail,
    updateTradeIn: state.dealerAdminReducer.dealerApplicationReducer.updateTradeIn,
    updateSellerDetail:
      state.dealerAdminReducer.dealerApplicationReducer.updateSellerDetail,
    updateAddtionalInfo:
      state.dealerAdminReducer.dealerApplicationReducer.updateAddtionalInfo,
    deleteAddtionalInfo:
      state.dealerAdminReducer.dealerApplicationReducer.deleteAddtionalInfo,
    updateAssignAgent:
      state.dealerAdminReducer.dealerApplicationReducer.updateAssignAgent,
    ...
    loading_delete_addtional:
      state.dealerAdminReducer.dealerApplicationReducer
        .loading_delete_addtional,
    deleteVehicleDetail:
      state.dealerAdminReducer.dealerApplicationReducer.deleteVehicleDetail,
    loading_delete_vehicle:
      state.dealerAdminReducer.dealerApplicationReducer
        .loading_delete_vehicle,
    deleteUploadedDoc:
      state.dealerAdminReducer.dealerApplicationReducer.deleteUploadedDoc,
    ...
    loadingFlinksRequestId:
      state.dealerAdminReducer.dealerApplicationReducer
        .loadingFlinksRequestId,
    loadingFlinksLogin:
      state.dealerAdminReducer.dealerApplicationReducer.loadingFlinksLogin,
    flinks_login_id:
      state.dealerAdminReducer.dealerApplicationReducer.flinks_login_id,
    flinks_login_response:
      state.dealerAdminReducer.dealerApplicationReducer.flinks_login_response,
    delete_doc_id:
      state.dealerAdminReducer.dealerApplicationReducer.delete_doc_id,
    upload_doc_id:
      state.dealerAdminReducer.dealerApplicationReducer.upload_doc_id,
    co_applicant_delete:
      state.dealerAdminReducer.dealerApplicationReducer.co_applicant_delete,
    ...
    personal_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer.personal_complete,
    employement_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer.employement_complete,
    co_personal_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer.co_personal_complete,
    co_employement_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer
        .co_employement_complete,
    assets_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer.assets_complete,
    trade_in_complete_redux: state.dealerAdminReducer.dealerApplicationReducer.trade_in_complete,
    seller_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer.seller_complete,
    addtional_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer.addtional_complete,
    ...
    loan_payment_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer.loan_payment_complete,
    loan_document_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer
        .loan_document_complete,
    upload_doc_complete_redux:
      state.dealerAdminReducer.dealerApplicationReducer.upload_doc_complete,
    loan_loading:
      state.dealerAdminReducer.dealerApplicationReducer.loan_loading,
    loan_delete:
      state.dealerAdminReducer.dealerApplicationReducer.loan_delete,
