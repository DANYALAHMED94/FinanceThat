...
class SearchMap extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            // radius: 50,
            radius: this.props.distance !== undefined && this.props.distance !== null && this.props.distance !== 0 && this.props.distance !== '' ? this.props.distance * 1000 : 1000,
            // radius: this.props.rangeSlider !== undefined && this.props.rangeSlider !== null && this.props.rangeSlider.length > 0 ? this.props.rangeSlider[1] !== undefined && this.props.rangeSlider[1] !== null && this.props.rangeSlider[1] !== 0 ? this.props.rangeSlider[1] * 1000 : 1000 : 1000,
            centerGps: null,
        }
    ...
    shouldComponentUpdate(nextProps, nextState) {
        // if (this.state.markerPosition.lat !== nextProps.autoComplete_lat || this.state.markerPosition.lng !== nextProps.autoComplete_lng)
        if (this.state.markerPosition.lat !== nextProps.autoComplete_lat || nextProps.autoComplete_update != this.props.autoComplete_update || nextProps.distance !== this.props.distance) {
            return true
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.distance !== this.props.distance && this.props.distance !== undefined) {
            // ?xKm to Meters
            const distance = Number(this.props.distance) !== 0 ? this.props.distance : 1
            circle.setRadius(parseFloat(distance * 1000));
            console.log(circle.getBounds())
...
export default connect(mapStateToProps, { change_map_lng_lat })(SearchMap)
