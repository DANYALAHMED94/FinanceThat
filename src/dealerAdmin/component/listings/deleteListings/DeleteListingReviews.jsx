...
import DeleteListingReviewUserDetail from './DeleteListingReviewUserDetail'
import DeleteListingReviewVehicleOverview from './DeleteListingReviewVehicleOverview'
import DeleteListingReviewLocation from './DeleteListingReviewLocation'
import DeleteListingReviewGallery from './DeleteListingReviewGallery';
import DeleteListingReviewVehicleDetail from './DeleteListingReviewVehicleDetail';
import Geocode from "react-geocode";
import { geocodeByAddress, getLatLng } from 'react-google-places-autocomplete';
import CKEditor from 'ckeditor4-react';

const DeleteListingReviews = (props) => {
        ...
        if (props.single_listing_detail !== undefined && props.single_listing_detail !== null) {
            ...
            (props.single_listing_detail || []).map(item => {
                ...
                setState({
                    ...
                    /**Vehicle Detail State */
                    vehicleCategory: item.category !== undefined && item.category !== null ? item.category.name !== undefined && item.category.name !== null ? item.category.name || '' : '' : '',
                    ...
                    vehicleMake: item.make !== undefined && item.make !== null ? item.make.make_name !== undefined && item.make.make_name !== null ? item.make.make_name || '' : '' : '',
                    vehicleModel: item.model !== undefined && item.model !== null ? item.model.model_make !== undefined && item.model.model_make !== null ? item.model.model_make || '' : '' : '',
                    ...
                    vehicleBodyType: item.body_type !== undefined && item.body_type !== null ? item.body_type.body_type !== undefined && item.body_type.body_type !== null ? item.body_type.body_type || '' : '' : '',
                    ...
                    vehicleFuelType: item.fuel_type !== undefined && item.fuel_type !== null ? item.fuel_type.fuel_type !== undefined && item.fuel_type.fuel_type !== null ? item.fuel_type.fuel_type || '' : '' : '',
                    vehicleDriveTrain: item.drive_train !== undefined && item.drive_train !== null ? item.drive_train.drive_train !== undefined && item.drive_train.drive_train !== null ? item.drive_train.drive_train || '' : '' : '',
    ...
    useEffect(() => {
        if (listLocation.location !== undefined && listLocation.location !== null) {
            new Promise((resolve, reject) => {
                ...
                //             listingLatitude: lat,
                //             locationName: listLocation.location.label !== undefined && listLocation.location.label !== null ? listLocation.location.label : state.location
                //         }),
                //         resolve()
                //     )
                //     .catch(err => {
    ...
    return (
        <React.Fragment>
            <div className="Admin-MainHead">
                ...
                <div className="Admin-HeadRight" ><h4 style={{ background: '#FA384F' }}>Deleted</h4></div>
            ...
            <div className="Admin-DealerLeft">
                ...
                <div className="InnerDealer-Container">
                    ...
                    <div className="InnerDealer-Head">
                        ...
                        <div className="InnerRight">
                            {/* <button type="button" onClick={() => setEditUser(!editUser)}><img src="/assets/image/icon-edit.svg" alt="" /></button> */}
                        </div>

                    </div>

                    <div className="DealerID-Container">
                        <DeleteListingReviewUserDetail handleOnChange={handleOnChange} state={state} {...props} editUser={editUser} setEditUser={setEditUser} />
                    </div>
                ...
                {/* <div className="InnerDealer-Container">
                    ...
                    <div className="InnerDealer-Head">
                        ...
                        <div className="InnerRight">
                            {/* <button type="button" onClick={() => setEditVehicleOverivew(!editVehicleOverivew)}><img src="/assets/image/icon-edit.svg" alt="" /></button> *
                        </div>
                    ...
                    <div className="DealerID-Container">
                        ...
                        <DeleteListingReviewVehicleOverview handleOnChange={handleOnChange} state={state} {...props} editVehicleOverivew={editVehicleOverivew} setEditVehicleOverivew={setEditVehicleOverivew} />
                ...
                <div className="InnerDealer-Container">
                    ...
                    <DeleteListingReviewLocation setVehicleLocation={setVehicleLocation} editVehicleLocation={editVehicleLocation} listLocation={listLocation} {...props} handleLocationChange={handleLocationChange} />
                ...
                <div className="InnerDealer-Container">
                    ...
                    <div className="InnerDealer-Head">
                        ...
                        <div className="InnerRight">
                            {/* <button type="button" onClick={() => setEditListingImages(!editListingImages)}><img src="/assets/image/icon-edit.svg" alt="" /></button> */}
                        </div>

                    </div>

                    <div className="ListGallery">
                        <DeleteListingReviewGallery state={state} {...props} editListingImages={editListingImages} onDrop={onDrop} removeFile={removeFile} />
                    </div>
        ...
        <button type="submit"><img src="image/icon-edit.svg" alt=""/></button>
            ...
            <div className="Admin-DealerRight">
                ...
                <div className="InnerDealer-Container">
                    ...
                    <div className="DealerID-Container">
                        <DeleteListingReviewVehicleDetail state={state} {...props} editVehicle={editVehicle} setEditVehicle={setEditVehicle} handleOnChange={handleOnChange} />
                    </div>
                        ...
                        <table class="table">
                            <tbody>
                                {props.loading_listing_detail === true ? (
                                    ...
                                    </tr>) : (state.vehicleFeature || []).map((item, index) => (
                                        <tr key={index}>
                                            {(index + 1) % 2 !== 0 ?
...
export default DeleteListingReviews