                ...
                <div class="col-sm-6">
                    {props?.emailIcon ?
                        <div class="input-group mb-3">
                            ...
                            <input onChange={props.onChange} name={props.name} type="text" class="form-control form-control-border-left" placeholder={props?.title} aria-label="Default" aria-describedby="inputGroup-sizing-default" value={props.value} />
                        </div>
                        :
                        <input onChange={props.onChange} name={props.name} type="text" class="form-control" placeholder={props?.title} value={props.value}/>}
                </div>
            </div>
