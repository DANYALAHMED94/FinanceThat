...
class CoApplicant extends Component {
  ...
  render() {
    ...
    const horizontalLabelsPrevious = {
      0: "$0",
      [`${
        this.props.previousDefaultCoGrossIncome !== null &&
        this.props.previousDefaultCoGrossIncome !== ""
          ? this.props.previousDefaultCoGrossIncome
          : 150000
      }`]: `${
        this.props.previousDefaultCoGrossIncome !== null &&
        this.props.previousDefaultCoGrossIncome !== ""
          ? new Intl.NumberFormat("en-US", {
              style: "currency",
              currency: "USD",
            }).format(Number(this.props.previousCoGrossIncome)) // '$100.00'
          : new Intl.NumberFormat("en-US", {
              style: "currency",
              currency: "USD",
            }).format(0)
      ...
      <React.Fragment>
        <div className="app-form-content">
          <div className="app-form-content-inner">
            ...
            <ul
              className="nav nav-tabs-2 nav-tabs-3 admin-tabs two-items"
              id="formAppTabs"
              role="tablist"
            >
              <li
                  ...
                  <React.Fragment>
                    <div className="forms-head clearfix">
                      ...
                      {this.props.coApplicantId ? (
                        <Link
                          to={
                            "/dealer-admin/co-applicant-credit-report/" +
                            ...
                            <div className="form-field-row two-col clearfix">
                              ...
                              <div className="form-field-col">
                                ...
                                <input
                                  type="text"
                                  className="form-control"
                                  name="coPreviousCountry"
                                  placeholder="Country"
                                  value={this.props.coPreviousCountry}
                                  onChange={this.props.handleOnChange}
                                />
                              </div>
                            </div>
                            ...
                            <div className="flexCenter">
                              <div className="flexCenter mr-3">
                                <NumberFormat
                                  required
                                  className="form-control"
                                  value={this.props.coEmploymentSinceYear}
                                  onChange={this.props.handleOnChange}
                                  allowNegative={false}
                              ...
                              <div className="flexCenter">
                                <NumberFormat
                                  required
                                  className="form-control"
                                  value={this.props.coEmploymentSinceMonth}
                                  onChange={this.props.handleOnChange}
                                  allowNegative={false}
