...
class EditDealerAdminApplication extends Component {
  ...
  componentDidMount() {
    if (this.props.location.pathname !== '/dealer-admin/application/addForm/applicant-detail') {
      history.push('/dealer-admin/application/addForm/applicant-detail')
    }
            ...
            ? (this.props.application_detail.vehicle || []).map((item) => {
              return {
                ...
                sub_type_of_vehicle: item.sub_type_of_vehicle !== undefined &&
                  ...
                  : "",
                selectedSubTypeOfVehicle:
                  item.sub_type_of_vehicle !== undefined &&
                    item.sub_type_of_vehicle !== null
                    ? (subTypeOfVehicle || []).filter(
                      (typeVehcile) =>
                        Number(typeVehcile.value) ===
                        Number(item.sub_type_of_vehicle)
                    ) !== undefined &&
                      (subTypeOfVehicle || []).filter(
                        (typeVehcile) =>
                          Number(typeVehcile.value) ===
                ...
                tonnage: item.tonnage !== undefined &&
                  ...
                  ? item.tonnage
                  : "",
                selectedTonnage: { value: item?.tonnage, label: item?.tonnage },
      ...
      this.setState({
        ...
        salutation:
          this.props.application_detail.salutation !== undefined &&
            ...
            : "",
        selectSalutation: this.state.salutations.find((el) =>
          (el.value === this.props.application_detail.salutation) !==
            undefined && this.props.application_detail.salutation !== null
            ? this.props.application_detail.salutation
            : ""
        ),
        gender:
            ...
            ? (this.props.application_detail.vehicle || []).map((item) => {
              return {
                ...
                sub_type_of_vehicle: item.sub_type_of_vehicle !== undefined &&
                  ...
                  ? item.sub_type_of_vehicle
                  : "",
                selectedSubTypeVehicle: item.sub_type_of_vehicle
                  ? (this.state.subTypeVehicleOptions || []).filter(
                    (typeVehcile) =>
                      Number(typeVehcile.value) ===
                      Number(item.sub_type_of_vehicle)
                  ) !== undefined &&
        ...
        applicantEmail:
          this.props.application_detail != undefined &&
            this.props.application_detail != null ?
            this.props.application_detail?.applicant_email_by_dealer ? this.props.application_detail?.applicant_email_by_dealer
            ...
            <div className="side-bar-content">
              <div className="sidebar-head clearfix">
                ...
                <div className="row report-btn py-3">
                  <div class="col-md-6">
                    <span>
                  {this.state.application_credit_detail ? this.state.application_credit_detail.credit ? this.state.application_credit_detail.credit[0] ? this.state.application_credit_detail.credit[0].score ? this.state.application_credit_detail.credit[0].score : null : null : null : null}
                  </span>
                    {/* <Link
                      to={"#"}
                  ...
                  <div class="col-md-6 p-0">
                    {/* <Link to={"#"} className="btn disable px-2">
