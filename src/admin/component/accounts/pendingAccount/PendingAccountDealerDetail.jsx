...
const PendingAccountDealerDetail = (props) => {
    ...
    <React.Fragment>
      <div className="PrimeOwner-Head">
        ...
        <div className="OwnerRight">
          {/* <button type="button" className="newbtn-add" disabled={!edit} > {props.update_dealer_detail === true ? (<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>) : null} Update</button> */}
        </div>
      </div>
            ...
            <tbody>
              {(state || []).map((item, index) => (
                <tr key={index}>
                  ...
                  {/* <td>{item.date_of_birth !== undefined && item.date_of_birth !== null && item.date_of_birth !== "" ? moment(item.date_of_birth).format("yyyy-MM-DD") : ''}</td> */}
                  <td>
                    {props.loading === true ? (
                      <i
                        class="fa fa-circle-o-notch fa-spin"
...
export default PendingAccountDealerDetail;
