...
import $ from 'jquery'
const DealerAdminNewlistings = props => {
                    ...
                    <table style={{ width: "100%" }} id="dashboardListingDatatable">
                        ...
                        <tbody>
                            {dashboard_listings !== undefined && dashboard_listings !== null ? (dashboard_listings || []).map((item, index) => (<tr key={index}>
                                ...
                                <td>{props.loading_dashboard_listings === true ? (<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>) : item.city !== undefined && item.city !== null ? item.city || '' : ''}</td>
                                ...
                                <td><Link to={`/dealer-admin/pending-listing/${props.loading_dashboard_listings === true ? (<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>) : item.stock_id ? item.stock_id : ''}`} >Review</Link></td>
                            </tr>)) : null}
                        </tbody>
                    </table>
                    <div className="ListView-Btn"><Link to='/dealer-admin/pending-listing' >View all listings</Link></div>
                </div>
...
export default DealerAdminNewlistings;