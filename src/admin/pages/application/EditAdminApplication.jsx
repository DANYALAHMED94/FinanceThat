...
coApplicantPreviousSelectedMonthlyGrossIncome:"",
    ...
    if (requiredFile) {
      if (requiredFile.isRequest === false) {
        ...
        const data = {
          ...
          additional_item: [],
          by_admin: false,
          email_address: this.state.applicantEmail,
           screen_link:`${window.location.origin}/buyer/my-application/${this.props.buyerAppId}/upload-doc`
        };
  ...
  componentDidUpdate(prevProps, prevState) {
          ...
          ? this.props.application_detail.vehicle !== undefined &&
            ...
            ? (this.props.application_detail.vehicle || []).map((item) => {
              return {
                ...
                selectedClientBudget:this.state.clientBudgetOptions?.filter(ite=> ite.value === item?.client_budget || "")?.[0] || "",
    ...
    if (
      ...
      const selectedApplicationStatus = this.props.application_detail
        ...
        const sellerFirstName =  this.props.application_detail
        ? this.props.application_detail?.seller
          ? this.props.application_detail?.seller?.first_name
            ? this.props.application_detail?.seller?.first_name || ""
            : ""
          : ""
        : "";
     const sellerLastName=  this.props.application_detail
        ? this.props.application_detail?.seller
      ...
      this.setState({
        ...this.state,
        applicantType:this.getApplicantType(this.props.application_detail?.user?.user_type || ""),
      ...
      loanFrequencyPayment: this.props.application_detail?.loan
        ...
        gender:
          this.props.application_detail.gender !== undefined &&
            ...
            : "",
        selectGender: this.state.genders.filter(
        ...
        selectedPreviousProvince: this.state.provinces.filter(
          (el) =>
            el.value ===
            this.props.application_detail?.previous_applicant_address?.province
        )?.[0] || "",
        ...
        previousSelectedStatus: this.state.statuses.filter(
          (el) =>
            el.value ===
            this.props.application_detail?.previous_applicant_address?.status
        )?.[0] || "",
        ...
        previousEmploymentStatus:
          this.props.application_detail?.previous_employer_address
            ?.employement_status,
        selectPreviousEmploymentStatus: this.state.employmentStatuses.filter(
          (el) =>
            el.value ===
            this.props.application_detail?.previous_employer_address
              ?.employement_status
        ...
        previousTypeOfEmployment:
          this.props.application_detail?.previous_employer_address
            ?.type_of_employment,
        selectedPreviousTypeOfEmployment: this.state.typeOfEmployments.filter(
          (el) =>
            el.value ===
            this.props.application_detail?.previous_employer_address
              ?.type_of_employment
      ...
      assetsDetailsForm: this.props.application_detail
        ...
        sellerLastName:
          this.props.application_detail !== undefined &&
            ...
            sellerWebsite:this.props.application_detail !== undefined &&
            this.props.application_detail !== null
            ? this.props.application_detail.seller !== undefined &&
              this.props.application_detail.seller !== null
              ? this.props.application_detail.seller.website !== undefined &&
                this.props.application_detail.seller.website !== null
                ? this.props.application_detail.seller.website
                : ""
              : ""
            : "",
        sellerProvince:
          ...
          this.props.application_detail !== undefined &&
            ...
            ? this.props.application_detail.seller !== undefined &&
              ...
              ? this.props.application_detail.seller.telephone !== undefined &&
                ...
                ? this.props.application_detail?.seller.telephone?.length === 11 ? this.props.application_detail?.seller.telephone?.slice(-10): this.props.application_detail?.seller.telephone?.replace("+1", "").trim()
                : ""
                : "": "",
        sellerEmail:
          this.props.application_detail !== undefined &&
        ...
        sellerCity:
          this.props.application_detail !== undefined &&
            ...
            ? this.props.application_detail.seller !== undefined &&
              ...
              : ""
            : "",
        sellerType: this.props.application_detail?.stock ? this.props.application_detail?.user?.user_type === 1  ? "buyer" : "dealer" : "",
        selectedSellerType:this.props.application_detail?.stock ?  this.props.application_detail?.user?.user_type === 1 ? {
          value:'buyer',
          label:"Private"
        }: {
          value:'dealer',
          label:"Dealer"} : "",
        privateSeller:this.props.application_detail?.looking_for_private_seller,
        selectedPrivateSeller:(this.state.privateSellers || [])?.filter(item => {return (item.value === (this.props.application_detail?.looking_for_private_seller || false))})?.[0],
        //  AddtionalInformation
        addtionalInformation:
          this.props.application_detail !== undefined &&
            this.props.application_detail !== null
        ...
        ? this.props.application_detail.co_applicant !== null &&
          ...
          ? this.props.application_detail.co_applicant.telephone !==
            ...
            ? this.props.application_detail?.co_applicant?.telephone?.length === 11 ? this.props.application_detail?.co_applicant?.telephone?.slice(-10): this.props.application_detail?.co_applicant?.telephone?.replace("+1", "").trim()
            : ""
          : ""
        : "",
        coApplicantAddress:
        ...
        selectCoGender: this.state.genders.filter(
          (el) =>
        ...
        selectedPreviousCoApplicantProvince: this.state.provinces.filter(
          (el) =>
            el.value ===
            this.props.application_detail?.co_applicant
              ?.previous_applicant_address?.province
        ...
        coApplicantPreviousStatus: this.state.statuses.filter(
          (el) =>
            el.value ===
            this.props.application_detail?.co_applicant
              ?.previous_applicant_address?.status
        ...
        selectPreviousCoApplicantEmploymentStatus:
          this.state.employmentStatuses.filter(
            (el) =>
              el.value ===
              this.props.application_detail?.co_applicant
        ...
        selectedPreviousCoApplicantTypeOfEmployment:
          this.state.typeOfEmployments.filter(
            (el) =>
              el.value ===
              this.props.application_detail?.co_applicant
  ...
  render() {
    ...
    return (
      ...
      <a className="back" href={`${this.state.mainUrl}`}>
              ...
              <div className="sidebar-head clearfix">
                ...
                <div className="row report-btn py-3">
                    <div className="col-md-6 p-0 mr-2">
                      <Link
                        to={this.state.buyerAppId ?
                          "/admin/application/credit-report/" +
                          this.state.buyerAppId : "#"
                        }
                        className={this.state.buyerAppId ? "btn btn-primary px-3" : "btn disable px-3"}
                        target="_blank"
                      >
                        {"Applicant Credit Report >"}
                      </Link>
                    </div>
                    <div style={{width:"45%"}} class="col-md-5 p-0">
                      <Link to={this.state.coApplicantId ?'/admin/application/co-applicant-credit-report/' + this.state.coApplicantId : "#"} className={this.state.coApplicantId ? "btn btn-primary px-2" : "btn disable px-2"} target="_blank">
                ...
                {/* <div className="row py-2">
                  <div className="col-md-12">
                    <div className="font-weight-light"><span style={{ color: '#fff' }}> Funding details </span></div>
                  </div>
                </div> */}
                {/* <div className="row py-1">
                  <div className="col-md-6"><span className="amount-label" style={{ color: '#fff' }}> Amount financed: </span></div>
                ...
                {/* <div className="row">
                  <div className="col-md-7"><span style={{ color: '#fff' }}> Estimated monthly payment: </span></div>
                  <div className="col-md-5">
                    <span className="monthly" style={{ float: 'right' }}>
                      {" "}
                      {this.state.monthlyAmount !== null &&
                ...
                <div className="application-status" id="dropdown-basic">
                  ...
                  {/* <Select
                                    ...
                                    name={'selectedApplicationStatus'}
                                    defaultValue={this.state.selectedApplicationStatus}
                                    value={this.state.selectedApplicationStatus}
                                    onChange={(e) => this.changeSelectStatus(e, 'applicationStatus', 'selectedApplicationStatus', 'selectApplicationStatus')}
                                    ...
                                    isDisabled={!this.state.buyerAppId}
                                /> */}
                  {/* {Number(this.state.applicationStatus) === Number('1') ? (
                                    <React.Fragment>
                                    ...
                                    <React.Fragment>
                                        <span className="status declinded"> {this.state.applicationStatus === 'pending' ? 'Unverified' : this.state.applicationStatus}  </span>
                                    </React.Fragment>)} */}
                </div>
              </div>
...
const mapStateToProps = (state) => {
  return {
    ...
    deleteAddtionalInfo:
      ...
      updateTradeIn: state.adminReducer.adminAccounts.applicationReducer.updateTradeIn,
    updateAssignAgent:
