...
class AddPostApplications extends Component {
  ...
  changeEmployementInformation = (val) => {
    ...
    if (val === 3) {
      ...
      if (this.state.previousEmploymentStatus === "Retired") {
        if (!this.validator.fieldValid("Previous Gross Income")) {
          this.validator.showMessageFor("Previous Gross Income");
          this.forceUpdate();
          return false;
        }
      }
  ...
  changeCoEmploymentStep = (val) => {
    ...
    if (val === 3) {
      ...
      if (this.state.coEmploymentStatus === "Retired") {
        if (!this.validator.fieldValid("Co Applicant Previous Gross Income")) {
          this.validator.showMessageFor("Co Applicant Previous Gross Income");
          this.forceUpdate();
          return false;
        }
      }
