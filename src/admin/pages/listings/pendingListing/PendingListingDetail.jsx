...
const mapStateToProps = (state) => {
    return {
        ...
        loading_listing_make_model: state.adminReducer.adminAccounts.listingReducer.loading_listing_make_model,
        success_listing_make_model: state.adminReducer.adminAccounts.listingReducer.success_listing_make_model,
        loading_listing_decline: state.adminReducer.adminAccounts.listingReducer.loading_listing_decline,
        loading_listing_approved: state.adminReducer.adminAccounts.listingReducer.loading_listing_approved,
