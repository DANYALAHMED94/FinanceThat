    ...
    return (
        <>
            <tr key={item.id}>
                ...
                <td>
                {item?.user?.user_type === 5 ? "Agent" : item?.user?.user_type === 3 ? "Admin" : item?.user?.user_type === 2 ? "Dealer" : item?.user?.user_type === 1 ? "Applicant" : item?.user?.user_type === 4 ? "Manager" :"-"}                </td>
                <td>
