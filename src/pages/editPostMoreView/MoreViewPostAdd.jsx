...
class MoreViewPostAdd extends Component {
    constructor(props) {
        super(props)
        this.state = {
            card: null,
    ...
    onDrop = async (files, id) => {
        ...
        for (const item of files) {
            if (item.type != "image/png" && item.type != "image/jpg" && item.type != "image/jpeg") {
                ...
                console.log(emptyPreviewFiles, 'emptyPreviewFiles')
                ...
                console.log(emptyFiles, 'emptyFiles')
                index++
            }
            that.setState({
                ...that.state,
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevState.typeOfVehicle !== this.state.typeOfVehicle && this.state.typeOfVehicle !== '' && this.state.typeOfVehicle !== undefined) {
            ...
            this.setState({
                ...
                deletedImages: this.state.files,
                isBlocking: true,
                imageErrors: [],
                cardNumber: '',
                cardExpiry: '',
        ...
        if (prevState.defaultSelectedBoost !== this.state.defaultSelectedBoost && this.state.defaultSelectedBoost !== undefined && this.state.defaultSelectedBoost !== 'free' && this.state.defaultSelectedBoost !== '') {
            ...
            if (subType === '') {
                ...
                console.log('startPercent ', startPercent)
                // typeOfVehicleScreens = subType !== '' ? 19 : typeMotor !== '' ? 12 : typeBoat !== '' ? 15 : typeRV !== '' ? 11 : typeSmall !== '' ? 10 : typeTrailer !== '' ? 10 : 19
                typeOfVehicleScreens = subType ? 16 : typeMotor ? 12 : typeBoat ? 15 : typeRV ? 11 : typeSmall ? 11 : typeTrailer ? 10 : 19
                // photoScreen = subType !== '' ? 20 : typeMotor !== '' ? 13 : typeBoat !== '' ? 16 : typeRV !== '' ? 12 : typeSmall !== '' ? 11 : typeTrailer !== '' ? 11 : 20
                photoScreen = subType ? 17 : typeMotor ? 13 : typeBoat ? 16 : typeRV ? 12 : typeSmall ? 12 : typeTrailer ? 11 : 20
                // locationScreen = subType !== '' ? 21 : typeMotor !== '' ? 14 : typeBoat !== '' ? 17 : typeRV !== '' ? 13 : typeSmall !== '' ? 12 : typeTrailer !== '' ? 12 : 21
                locationScreen = subType ? 18 : typeMotor ? 14 : typeBoat ? 17 : typeRV ? 13 : typeSmall ? 13 : typeTrailer ? 12 : 21
                // boostScreen = subType !== '' ? 22 : typeMotor !== '' ? 15 : typeBoat !== '' ? 18 : typeRV !== '' ? 14 : typeSmall !== '' ? 13 : typeTrailer !== '' ? 14 : 22
                boostScreen = subType ? 19 : typeMotor ? 15 : typeBoat ? 18 : typeRV ? 14 : typeSmall ? 14 : typeTrailer ? 13 : 22
                // paymentScreen = subType !== '' ? 23 : typeMotor !== '' ? 16 : typeBoat !== '' ? 19 : typeRV !== '' ? 15 : typeSmall !== '' ? 14 : typeTrailer !== '' ? 14 : 23
                paymentScreen = subType ? 20 : typeMotor ? 16 : typeBoat ? 19 : typeRV ? 15 : typeSmall ? 15 : typeTrailer ? 14 : 23
                newStepName = subType ? 'VIN Number' : typeName === ('Automotive').toUpperCase() ? 'VIN Number' : typeName === ('Boat').toUpperCase() ? 'HIN Number' : typeName === ('Small Equipment').toUpperCase() ? 'Serial Number' : '';
                engineStepName = typeName === ('Boat').toUpperCase() ? 'Engine Horsepower' : typeName === ('Motorcycle').toUpperCase() ? 'Engine CC' : typeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 'Engine CC' : '';
                newStep = subType ? false : typeName === ('Automotive').toUpperCase() ? true : typeName === ('Boat').toUpperCase() ? true : typeName === ('Small Equipment').toUpperCase() ? true : typeName === ('Motorcycle').toUpperCase() ? true : false;
                ...
                const bar = 100
                startPercent = subTypeAtv ? bar / 17 : bar / 22
                typeOfVehicleScreens = subTypeAtv ? 12 : 16
                photoScreen = subTypeAtv ? 13 : 17
                locationScreen = subTypeAtv ? 14 : 18
                boostScreen = subTypeAtv ? 15 : 19
                paymentScreen = subTypeAtv ? 16 : 20
                newStepName = subType || subTypeAtv ? 'VIN Number' : '';
                engineStepName = subType || subTypeAtv ? 'Engine CC' : '';
                newStep = subType || subTypeAtv ? true : false;
            }
            ...
            this.setState({
                ...
                postSteps: this.state.postSteps.slice().map(item => {
                    ...
                    return {
                        ...
                        completed: false,
                        current: item.value === 4 ? true : false,
                        perc: item.value === 4 ? Number(startPercent) * Number(locationScreen) : item.parc,
                        disbaled: item.value === 5 ? true : false
                        // current: item.value === 6 ? true : false
                    }
                })
            },()=>{console.log("2",this.state.tab)})
        }
        if (prevState.defaultSelectedBoost !== this.state.defaultSelectedBoost && this.state.defaultSelectedBoost !== undefined && this.state.defaultSelectedBoost === 'free' && this.state.defaultSelectedBoost !== '') {
            let typeName = this.state.selectedTypeName
            typeName = typeName !== undefined && typeName !== null ? typeName.toUpperCase() : ''
        ...
        if (prevProps.post_ad_detail_edit !== this.props.post_ad_detail_edit && this.props.post_ad_detail_edit !== undefined && this.props.post_ad_detail_edit.length > 0) {
            this.props.post_ad_detail_edit.map(item => {
                ...
                return this.setState({
                    ...
                    lastTab: 1,
                    lastTabIndex: 1,
                    engineCC: item.engine ? item.engine : '',
                    finalizeStep: 1,
                    ...
                    province: item.province !== undefined && item.province !== null ? item.province : '',
                    ...
                    hull_material: item.hull_material ? item.hull_material : '',
                    selectedHullMaterial: { label: item.hull_material ? item.hull_material : '', value: item.hull_material ? item.hull_material : '' }
                })

            })

        }
        if ((prevProps.vehicle_feature !== this.props.vehicle_feature && this.props.vehicle_feature !== undefined && this.props.vehicle_feature.length > 0)) {
            this.setState({
                ...this.state,
                vehicle_features: this.props.vehicle_feature.slice().map(item => {
                    return {
                        ...item,
        ...
        if (this.state.selectedTypeName.toUpperCase() === ("BOAT").toUpperCase()) {
            ...
            if (e === 9) {
                if ((this.state.price === '' || this.state.price === undefined || this.state.price === null) || (this.state.length === '' || this.state.length === undefined || this.state.length === null)) {
                    toastr.error('Error', 'Please Enter Price And Length')
                    return false
                }
            }
            // Remove Validation Due To Change in reuirement from client
    ...
    create_post = () => {
        ...
        if (this.state.selectedTypeName.toUpperCase() === ('Automotive').toUpperCase()) {
            ...
            let trim = ''
            if (this.state.trimName) {
                if (Array.isArray(this.state.trimName)) {
                    trim = this.state.trimName[0] ? this.state.trimName[0].label : ''
                } else {
            ...
            formData.append("engine", 0);
            formData.append('hours', '')
            formData.append("hin", '');
            formData.append('steering_type', '')
            formData.append('passengers', '')
            formData.append('length', '')
            formData.append('weight', '')
            formData.append('hull_material', '')
        ...
        if (this.state.selectedTypeName.toUpperCase() === ('Motorcycle').toUpperCase()) {
            ...
            formData.append("selectTrim", '');
            formData.append("transmission ", '');
            formData.append("fuel_type", '');
            formData.append("drive_train", '');
            formData.append("cylinder", '');
            formData.append("body_type", '');
            formData.append("vin", '');
            formData.append("seating", '');
            formData.append('hours', '')
            formData.append("hin", '');
            formData.append('steering_type', '')
            formData.append('passengers', '')
        ...
        if (this.state.province !== undefined && this.state.province !== null && this.state.province !== '') {
            formData.append("province", this.state.province);
        }
        if (this.state.subTypeId && Number(this.state.typeOfVehicle) === 9) {
            formData.append("sub_type_id", this.state.subTypeId);
        } else {
            formData.append("sub_type_id", '');
        }
        if (this.state.checkPayment !== undefined && this.state.checkPayment !== null && this.state.checkPayment !== '') {
        ...
        formData.append("longitude", !this.state.longitude ? 0 : Number(this.state.longitude).toFixed(7));
        formData.append("latitude", !this.state.latitude ? 0 : Number(this.state.latitude).toFixed(7));
    ...
    render() {
        console.log(this.state.tab,this.state.step, this.state.finalizeStep)
...
const mapStateToProps = (state) => {
    return {
        ...
        vehicle_feature: state.adPostReducers.addPostReducer.vehicle_features,
