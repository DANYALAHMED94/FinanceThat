...
import {
    ...
    GET_ADDTIONAL_TYPE_DEALER, GET_VEHICLE_MAKES_EDIT_POST_APP_DEALER,
...
export const get_vehicle_type = () => {
    return dispatch => {
        dispatch({
            type: TOGGLE_VEHICLE_TYPE_DEALER,
            status: false
        })
...
export const get_application_agents = () => {
    return dispatch => {
        ...
        axios(options).then(response => {
            if (response.data.success !== undefined && response.data.success === true) {
                dispatch({
                    type: GET_AGENTS_APPLICATON_DEALER,
                    response: response.data.data,
                })
            } else {
...
export const get_pending_active_application = (data) => {
    return dispatch => {
        dispatch({
            type: GET_PENDING_ACTIVE_APPLICATIONS_DEALER,
            response: [],
            count: 0,
            pages: [],
        })
        dispatch({
            type: LOADING_DEALER_APPLICATIONS,
            status: true
        })
        dispatch({
...
export const single_check_application = (id) => {
    return dispatch => {
        dispatch({
            type: SINGLE_CHECK_APPLICATION_DEALER,
            id: id,
        })
    }
}
export const toggle_all_check = (status) => {
    return dispatch => {
        dispatch({
            type: TOGGLE_ALL_CHECK_APPLICATION_DEALER,
            status: status,
        })
    }
}
export const remove_update_row = () => {
    return dispatch => {
        dispatch({
            type: REMOVE_UPDATE_ROW_APPLICATION_DEALER
        })
    }
}
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: GET_ADDTIONAL_TYPE_DEALER,
                        response: response.data.data
                    })
                }
            })
    ...
    return dispatch => {
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: UPDATE_APPLICATION_ROW_DATA_DEALER,
                        response: response.data.data
                    })
                }
            })
...
export const get_vehicle_make = (id, index, prevId) => {
    return dispatch => {
        dispatch({
            type: TOGGLE_VEHICLE_MAKE_EDIT_POST_APP_DEALER,
            status: false
        })
        ...
        simpleAxios(options).then(response => {
            if (response.data.success !== undefined && response.data.success == true) {
                ...
                dispatch({
                    type: GET_VEHICLE_MAKES_EDIT_POST_APP_DEALER,
...
export const get_vehicle_model = (id, index, prevId) => {
    return dispatch => {
        dispatch({
            type: TOGGLE_VEHICLE_MODEL_EDIT_POST_APP_DEALER,
            status: false
        })
        ...
        simpleAxios(options).then(response => {
            if (response.data.success !== undefined && response.data.success == true) {
                dispatch({
                    type: GET_VEHICLE_MODEL_EDIT_POST_APP_DEALER,
                    response: response.data.data,
                    index: index,
                    prevId: prevId,
                    id: id
...
export const get_vehicle_trims = (modelId, index, prevId) => {
    return dispatch => {
        dispatch({
            type: TOGGLE_VEHICLE_TRIMS_EDIT_POST_APP_DEALER,
            status: false
        })
        ...
        simpleAxios(options).then(response => {
            if (response.data.success !== undefined && response.data.success == true) {
                dispatch({
                    type: GET_VEHICLE_TRIMS_EDIT_POST_APP_DEALER,
                    response: response.data.data,
                    index: index,
                    prevId: prevId,
                    id: modelId
...
export const update_application_detail = (data, screenName) => {//change here for createxs
    return dispatch => {
        dispatch({
            type: EDIT_POST_APP_LOADING_DEALER,
            status: true,
        })
        const url = `/application/${data.id}/`//change end point here
        const options = {
            method: 'PUT',
            headers: { "Content-Type": "application/json; charset=utf8" },
            data: data,
        ...
        axios(options)
            .then(response => {
                if (response.data.success === true) {
                    dispatch({
                        type: EDIT_POST_APP_UPDATE_DEALER,
        ...
        axios(options)
            .then(response => {
                if (response.data.success === true) {
                    ...
                    toastr.success(message.toString())
                    history.push(`/dealer-admin/application/general/${response?.data?.data?.id}`)
                }
                dispatch({
                    type: EDIT_POST_APP_LOADING_DEALER,
                    status: false,
    ...
    return dispatch => {
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: UPDATE_APPLICATION_STATUSES_DEALER,
                        stateName: stateName,
    ...
    return dispatch => {
        ...
        axios(options)
            .then(response => {
                if (response.data.success === true) {
                    dispatch({
                        type: EDIT_DEALER_POST_APP_UPDATE_UPLOAD_DOC,
                        response: response.data.data
                    })
                    const message = response.data.message !== undefined && response.data.message !== null ? response.data.message : 'Update Successfully'
                    toastr.success(message.toString())
...
export const remove_all_state_application = () => {
    return dispatch => {
        dispatch({
            type: REMOVE_ALL_STATE_APPLICATION_DEALER
        })
    }
}
export const delete_addtional_info = (id) => {
    return dispatch => {
        dispatch({
            type: DELETE_ADDTIONAL_INFO_LOADING_DEALER,
            status: true
        })
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: DELETE_ADDTIONAL_INFO_DEALER,
                    })
...
export const delete_vehicle_detail = (id) => {
    return dispatch => {
        dispatch({
            type: DELETE_VEHICLE_DETAIL_LOADING_DEALER,
            status: true
        })
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: DELETE_VEHICLE_DETAIL_DEALER,
                    })
                    const message = response.data.message !== undefined && response.data.message !== null ? response.data.message : 'Deleted Successfully'
                    toastr.success(message.toString())
...
export const delete_upload_doc = (id) => {
    return dispatch => {
        dispatch({
            type: DELETE_UPLOAD_DOC_LOADING_DEALER,
            status: true,
            id: id
        })
        ...
        axios(options)
            .then(response => {
                if (response.data.success === true) {
                    dispatch({
                        type: DELETE_UPLOADED_DOC_DEALER,
                        id: id
                    })
                    const message = response.data.message !== undefined && response.data.message !== null ? response.data.message : 'Deleted Successfully'
                    toastr.success(message.toString())
...
export const get_login_id_flinks = (data) => {
    return dispatch => {
        dispatch({
            type: LOADING_FLINKS_REQUEST_ID_DEALER,
            status: true
        })
        ...
        simpleAxios(options)
            .then(response => {
                ...
                if (response.data.success == true) {
                    dispatch({
                        type: FLINKS_REQUEST_ID_RESPONSE_DEALER,
                        response: response
                    })
                    const message = response.data.message !== undefined && response.data.message !== null ? response.data.message : 'Deleted Successfully'
                    toastr.success(message.toString())
...
export const login_flinks = (data) => {
    return dispatch => {
        dispatch({
            type: LOADING_FLINKS_LOGIN_ID_DEALER,
            status: true
        })
        ...
        simpleAxios(options)
            .then(response => {
                ...
                if (response.data.success == true) {
                    dispatch({
                        type: FLINKS_LOGIN_ID_RESPONSE_DEALER,
                        response: response
                    })
                    const message = response.data.message !== undefined && response.data.message !== null ? response.data.message : 'Deleted Successfully'
                    toastr.success(message.toString())
...
export const delete_single_row = (id, search) => {
    return dispatch => {
        ...
        dispatch({
            type: LOADING_DELETE_SINGLE_APPLICATION_DEALER,
            status: true,
            id: id
        })
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: DELETE_SINGLE_APPLICATION_DEALER,
                        id: id
                    })
                    const message = response.data.message !== undefined && response.data.message !== null ? response.data.message : 'Deleted Successfully'
                    toastr.success(message.toString())
    ...
    return dispatch => {
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: DELETE_MULTIPLE_APPLICATION_DEALER,
                        ids: ids
                    })
                    const message = response.data.message !== undefined && response.data.message !== null ? response.data.message : 'Deleted Successfully'
                    toastr.success(message.toString())
    ...
    return dispatch => {
        ...
        simpleAxios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: GET_CREDIT_REPORT_DATA_DEALER,
                        response: response.data.data
                    })
                }
            })
    ...
    return dispatch => {
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: GET_CO_APPLICANT_CREDIT_REPORT_DATA_DEALER,
                        response: response.data.data
                    })
                }
            })
...
export const get_stock_id_detail = (id) => {
    return dispatch => {
        dispatch({
            type: LOADING_DEALER_EDIT_POST_STOCK_DETAIL,
            status: true
        })
        dispatch({
            type: DEALER_EDIT_POST_STOCK_DETAIL,
            response: [],
        })
        // const url = `/ads/${id}/`
...
export const delete_coApplicant = (id) => {
    return dispatch => {
        dispatch({
            type: DEALER_DELETE_COAPPLICANT_LOADING,
            status: true
        })
        ...
        axios(options)
            .then(response => {
                if (response.data.success == true) {
                    dispatch({
                        type: DEALER_DELETE_COAPPLICANT_INFO,
                    })
                    const message = response.data.message !== undefined && response.data.message !== null ? response.data.message : 'Deleted Successfully'
                    toastr.success(message.toString())
