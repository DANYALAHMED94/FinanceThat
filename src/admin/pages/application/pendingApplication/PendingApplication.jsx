...
import PendingApplicationDatatable from "../../../component/Application/pendingApplication/PendingApplicationDatatable";
import {
...
class PendingApplication extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Helmet>
          <title>Pending Application List</title>
...
const mapStateToProps = (state) => {
  return {
    ...
    total_count:
      state.adminReducer.adminAccounts.applicationReducer.total_count,
    pages_urls: state.adminReducer.adminAccounts.applicationReducer.pages,
    agent_listing:
