...
class AddPost extends Component {
	...
	handleOnChange = (e) => {
		...
		// $('#type_of_vehicles').css('display', 'block');
	};
	hanldeOnChange = (e) => {
		const { name, value } = e.target;
		this.setState({
	...
	submitAdPost = () => {
		...
		formData.append("drivetrain", this.state.drivetrain);
		formData.append("cylinder", this.state.cylinder);
		formData.append("color", this.state.color);
		formData.append("previousOwner", this.state.previousOwner);
		formData.append("previousAccident", this.state.previousAccident);
		formData.append("featureName", this.state.featureName);
		formData.append("location", this.state.location);
		formData.append("otherModel ", this.state.otherModel);
		formData.append("selectModel", this.state.selectModel);
		formData.append("otherTrim", this.state.otherTrim);
		formData.append("trimName", this.state.trimName);
		formData.append("selectTrim", this.state.selectTrim);
		formData.append("selectYear", this.state.selectYear);
		formData.append("selectCondition", this.state.selectCondition);
		formData.append("kilometer", this.state.kilometer);
		formData.append("price", this.state.price);
		formData.append("bodyType", this.state.bodyType);
		formData.append("seating", this.state.seating);
		formData.append("files ", JSON.stringify(this.state.files));
		...
		formData.append("otherMake", this.state.otherMake);
		formData.append("searchMake", this.state.searchMake);
		formData.append("typeOfVehicle", this.state.typeOfVehicle);
									...
									<div className="row">
										...
										<div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
														...
														{this.state.step == 1 ? (
															<React.Fragment>
																<div className="owl-three owl-carousel owl-theme">
																	...
																	<div className="AdPost-SecThree" id="features">
																		<div className="row">
                                          ...
                                          <input
																	...
																	<div className="AdPost-SecOne" id="type_of_vehicles">
																		<div className="row">
																			<div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                          ...
                                          Browse Image
															...
															<React.Fragment>
																<div className="AdPost-SecFifteen">
																	...
																	<div className="row BrandMt">
																		<div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
																			<select className="form-control js-example-tags" name='location' onChange={this.handleOnChange}>
