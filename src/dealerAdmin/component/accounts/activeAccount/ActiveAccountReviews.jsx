...
import ActiveAccountDealerDetail from "./ActiveAccountDealerDetail";
import moment from "moment";
import MaskedInput from "react-text-mask";
import { API_URL } from "../../../../constant";
import NumberFormat from "react-number-format";

const ActiveAccountReviews = (props) => {
    ...
    <React.Fragment>
        ...
        <div className="Admin-DealerLeft">
          <div className="InnerDealer-Container">
            ...
            <div className="DealerID-Container">
              ...
              {/* {props.accountType !== 'Private' ? (<div className="DealerID-List">
      ...
      {props.accountType === "Dealer" ? (
        <div className="PrinOwner-Container" style={{ width: "943px" }}>
          <ActiveAccountDealerDetail {...props} />
        </div>
      ) : null}
    </React.Fragment>
  );
};
export default ActiveAccountReviews;
