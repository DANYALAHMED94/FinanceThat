...
const ArchiveListingReviewVehicleDetail = (props) => {
            ...
            <span>
              {props.loading_listing_detail === true ? (
                ...
                <input
                  ...
                  value={props.state.vehicleCategory}
                  onChange={props.handleOnChange}
                />
              ) : (
                props.state.vehicleCategory
              )}
            </span>
          </h2>
        </div>
        ...
        <div className="RightCon">
          <h2>
            {props.loading_listing_detail === true ? (
              ...
              props.state.vehicleTransmission
            )}
          </h2>
        </div>
      </div>
...
export default ArchiveListingReviewVehicleDetail;
