        ...
        vehicle: this.props.assetsDetails.map((item) => {
          if (item.id === "") {
            ...
            if (
              ...
              delete vehicleData.client_budget;
                  ...
                  <React.Fragment>
                    ...
                    {(this.props.assetsDetailsForm || []).map((item, index) => (
                      <div className="form-main" key={index}>
                            ...
                            <div className="form-field-col">
                              ...
                              <Select
                                ...
                                onChange={(e) => {
                                  ...
                                  // this.props.handleOnChangeAssetsClientBudget(e)
                                }}
                                value={item.selectedClientBudget}
                                className="react-select-main"
                                classNamePrefix="react-select"
                                components={{
                                  Option: renderOption,
                        ...
                        <div className="form-field-row two-col clearfix">
                          ...
                          <Select
                            ...
                            options={[
                              ...
                              {label: "5 or more years", value:"5 or more years"}
                            ]}
                            onChange={(e) =>
                              this.props.handleOnChangeYears(e)
                            }
                            value={this.props.duration_address_year}
                            className="react-select-main"
                            classNamePrefix="react-select"
                            components={{
                              Option: renderOption,
                          ...
                          {["powersport", "motorcycle", "boat"].includes(
                            item?.selectedVehicle?.label?.toLowerCase()
                          ) ? (
                            <div className="form-field-col">
                        ...
                        <div className="form-field-row two-col clearfix">
                          {["powersport", "motorcycle", "automotive"].includes(
                            item?.selectedVehicle?.label?.toLowerCase()
                          ) ? (
                            <div className="form-field-col">
                              <label> KM </label>
