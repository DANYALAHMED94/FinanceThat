...
class DealerList extends PureComponent {
      ...
      this.state.selectAllModels === true && this.state.modelFilterName === ""
        ...
        : (this.state.selectedModel || []).length > 0
          ? this.state.selectedModel
            ...
            : ""
          : this.state.modelFilterName !== ""
            ? JSON.stringify([this.state.modelFilterName])
            : "";
    const makeName =
      this.state.selectAllMakes === true && this.state.makeFilterName === ""
        ? ""
        : (this.state.selectedMakes || []).length > 0
          ? this.state.selectedMakes
            ...
            : ""
          : this.state.makeFilterName !== ""
            ? JSON.stringify([this.state.makeFilterName])
            : "";
    const typeVehicle =
      this.state.categoryFilterName === "All Vehicles"
        ? ""
  ...
  render() {
    ...
    console.log(this.state, "dsaasd");
    let first = this.state.name !== undefined && this.state.name !== null && this.state.name !== '' ? this.state.name.split(' ')[0] : ''
    let last = this.state.name !== undefined && this.state.name !== null && this.state.name !== '' ? this.state.name.split(' ')[1] : ''
          ...
          <div className="banner-detail-sec">
            <div className="dealer-detail-col">
              <div className="dealer-logo-holder">
                {/* <img src={this.props.photo !== null && this.props.photo !== undefined ? API_URL + this.props.photo : "/assets/image/dealer-logo.svg"} alt="" /> */}
                {this.state.logoPath ? <img
                  src={
                    this.state.logoPath
                  ...
                  alt=""
                /> : (<span className="dealer-list-avatar"> {`${first}${last}`} </span>)}
              </div>
            </div>
            <div className="dealer-detail-col">
              <div className="dealer-detail">
                ...
                <ul className="dealer-detail-list clearfix">
                  {this.state.city ? <li className="dealer-detail-list-item location">
                    <span className="detail-icon"> </span>
                    {this.state.city
                      ? this.state.city
                      : ""}
                  </li> : null}
                  {this.state.telephone ? <li className="dealer-detail-list-item tel">
                    <span className="detail-icon"> </span>
                  ...
                  {this.state.email ? <li className="dealer-detail-list-item email">
                    <span className="detail-icon"> </span>
                    {this.state.email
                      ? this.state.email
                      : ""}
                  </li> : null}
                  {this.state.website ? (<li className="dealer-detail-list-item url">
                    <span className="detail-icon"> </span>
                    {this.state.website}
                  </li>) : null}
                </ul>
                ...
                <div className="MobileSearch mb-0">
                  ...
                  >
                    <input
                      ...
                      disabled
                    />
                    {/* <input type="text" id="searchKm" name="searchKm" placeholder="Add location" value={this.state.searchKm} onChange={this.handleOnChange} /> */}
                    <i className="icon-subtract-icon"></i>
                  </div>
