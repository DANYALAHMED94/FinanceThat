...
import DeletedApplicationDatatable from "../../../component/Application/deletedApplication/DeletedApplicationDatatable";
import {
...
class DeletedApplication extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Helmet>
                    <title>Deleted Application List</title>
