...
import DealerActiveListingTable from "../../../component/listings/activeListings/DealerActiveListing";
import {
  get_listing,
...
class DealerActiveListing extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tab: "dealer",
