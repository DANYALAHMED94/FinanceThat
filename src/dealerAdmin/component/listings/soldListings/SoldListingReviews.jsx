...
import SoldListingReviewUserDetail from './SoldListingReviewUserDetail'
import SoldListingReviewVehicleOverview from './SoldListingReviewVehicleOverview'
import SoldListingReviewLocation from './SoldListingReviewLocation'
import SoldListingReviewGallery from './SoldListingReviewGallery';
import SoldListingReviewVehicleDetail from './SoldListingReviewVehicleDetail';
import Geocode from "react-geocode";
import { geocodeByAddress, getLatLng } from 'react-google-places-autocomplete';
import CKEditor from 'ckeditor4-react';

const SoldListingReviews = (props) => {
    ...
    return (
        <React.Fragment>
            <div className="Admin-MainHead">
                ...
                <div className="Admin-HeadRight"><h4>Sold</h4></div>
            ...
            <div className="Admin-DealerLeft">
                ...
                <div className="InnerDealer-Container">
                    ...
                    <div className="DealerID-Container">
                        <SoldListingReviewUserDetail handleOnChange={handleOnChange} state={state} {...props} editUser={editUser} setEditUser={setEditUser} />
                    </div>
                ...
                {/* <div className="InnerDealer-Container">
                    ...
                    <div className="DealerID-Container">
                        ...
                        <SoldListingReviewVehicleOverview handleOnChange={handleOnChange} state={state} {...props} editVehicleOverivew={editVehicleOverivew} setEditVehicleOverivew={setEditVehicleOverivew} />
                ...
                <div className="InnerDealer-Container">
                    ...
                    <SoldListingReviewLocation setVehicleLocation={setVehicleLocation} editVehicleLocation={editVehicleLocation} listLocation={listLocation} {...props} handleLocationChange={handleLocationChange} />
                ...
                <div className="InnerDealer-Container">
                    ...
                    <div className="ListGallery">
                        <SoldListingReviewGallery state={state} {...props} editListingImages={editListingImages} onDrop={onDrop} removeFile={removeFile} />
                    </div>
        ...
        <button type="submit"><img src="image/icon-edit.svg" alt=""/></button>
            ...
            <div className="Admin-DealerRight">
                ...
                <div className="InnerDealer-Container">
                    ...
                    <div className="DealerID-Container">
                        <SoldListingReviewVehicleDetail state={state} {...props} editVehicle={editVehicle} setEditVehicle={setEditVehicle} handleOnChange={handleOnChange} />
                    </div>
...
export default SoldListingReviews