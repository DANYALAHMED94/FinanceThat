...
const PrivateExpireListing = (props) => {
  ...
  const componentRefExpireDeleteListing = React.useRef(null);
  ...
  const delete_single_listing = (id) => {
    props.soft_delete_single_listing(id, "Search Active Listing");
  };
  const delete_multiple_listing = () => {
    ...
    props.soft_delete_listings(ids, "Search Active Listing");
  };
  const reactToPrintContent = React.useCallback(() => {
    return componentRefExpireDeleteListing.current;
  }, [componentRefExpireDeleteListing.current]);
  ...
  return (
    <React.Fragment>
      <div className="AlContainer">
        ...
        {/* <div className="ActiveList-Right"><button type="button" onClick={deleteListing} disabled={(props.listing_detail || []).filter(item => item.isChecked === true).length === 0}>{props.loading_listing_delete === true ? (<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>) : null}Delete</button></div> */}
      </div>
      ...
      <div className="Altable-Container">
        <div className="Admin-dtable">
          ...
          <table
            style={{ width: "100%" }}
            id=""
            ref={componentRefExpireDeleteListing}
          >
            <thead>
              <tr>
                <th>
                  ...
                  <div className="imgprint">
                    ...
                    >
                      <CSVLink
                        data={exportData}
                        headers={headers}
                        filename={"Active_Private_Listings.csv"}
                      >
                        <img
                    ...
                    <ReactToPrint
                      documentTitle="Expired Listing Seller Record"
...
export default PrivateExpireListing;
