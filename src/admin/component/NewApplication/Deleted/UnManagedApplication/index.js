...
const UnManagedApplication = () => {
    ...
    console.log(searchParams, "searchParams.p_size, changeSelect, debouncedSearchTerm")
    return (
        <>
            <div className="Altable-Container lower">
                <ApplicationTableTopHeader deleted={true}/>
                <div className="p-2">
