...
const PrivateActiveListing = (props) => {
  ...
  const componentRefActiveDeleteListing = React.useRef(null);
  ...
  const reactToPrintContent = React.useCallback(() => {
    return componentRefActiveDeleteListing.current;
  }, [componentRefActiveDeleteListing.current]);
      ...
      <div className="Altable-Container">
        <div className="Admin-dtable">
          ...
          <table
            style={{ width: "100%" }}
            id=""
            ref={componentRefActiveDeleteListing}
          >
            <thead>
              <tr>
                <th>
...
export default PrivateActiveListing;
