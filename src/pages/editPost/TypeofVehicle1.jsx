...
const TypeofVehicle = (props) => {
    ...
    const vehcile_mokes = props.state.selectedTypeName.toUpperCase() === ('Automotive').toUpperCase() ? (props.vehicle_makes || []).map((item, index) => (
        <React.Fragment key={index}>
            {item.image_path !== null && item.image_path !== undefined ? (<div className="boxed-grid-col" key={index} style={{ minHeight: '96.81px' }}>
                <div className={props.state.selectVehicleMake == item.id ? "SelectCar-Brand active" : "SelectCar-Brand"} onClick={() => props.handleOnClick('selectVehicleMake', item.id)} style={{ minHeight: '70.81px' }}>
    ...
    // const motorSelectNext = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 9 : (props.state.selectedTypeName.toUpperCase() === ('RV').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) ? 15 : props.state.engineStepName === 'Engine Horsepower' ? props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 10 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 18 : 14 : 8
    // After Add RV
    // const motorSelectNext = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 9 : (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) ? 15 : props.state.engineStepName === 'Engine Horsepower' ? props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 10 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 18 : 14 : props.state.selectedTypeName.toUpperCase() === ('RV').toUpperCase() ? 7.1 : 8
    // After Add Trailer
    const motorSelectNext = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 9 : (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) ? 15 : props.state.engineStepName === 'Engine Horsepower' ? props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 10 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 18 : 14 : props.state.selectedTypeName.toUpperCase() === ('RV').toUpperCase() ? 7.1 : props.state.selectedTypeName.toUpperCase() === ('TRAILER').toUpperCase() ? 14 : 8
    // const motorSelectPrev = props.state.engineStepName === 'Engine Horsepower' ? props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 10 : 7 : 13
    const motorSelectPrev = props.state.engineStepName === 'Engine Horsepower' ? props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 10 : 7 : props.state.selectedTypeName.toUpperCase() === ('Trailer').toUpperCase() ? 7 : 13
    // const boatSelectPrev = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 7 : 9
    // const boatSelectPrev = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 10 : 9
    const boatSelectPrev = 10
    const boatSelectNext = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 15 : 12
    const boatSelectModelNext = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() || (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) ? 4.1 : props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() || props.state.selectedTypeName.toUpperCase() === ('Trailer').toUpperCase() ? 5 : props.state.selectedTypeName.toUpperCase() === ('Automotive').toUpperCase() ? 4 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 4.1 : 5
    // const boatSelectModelNext = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() || (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) ? 4.1 : props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 5 : props.state.selectedTypeName.toUpperCase() === ('Automotive').toUpperCase() ? 4 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 4.1 : 5
    const boatSelectModelPrev = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() || (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) || props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 3 : props.state.selectedTypeName.toUpperCase() === ('Automotive').toUpperCase() ? 4 : 3
    const boatSelectYearPrev = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() || (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) || props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 4.1 : props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() || props.state.selectedTypeName.toUpperCase() === ('Trailer').toUpperCase() ? 3 : props.state.selectedTypeName.toUpperCase() === ('Automotive').toUpperCase() ? 4 : 3
    // const boatSelectYearPrev = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() || (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) || props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 4.1 : props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 3 : props.state.selectedTypeName.toUpperCase() === ('Automotive').toUpperCase() ? 4 : 3
    const boatBackFuel = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 11 : (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) ? 7 : props.state.selectedTypeName.toUpperCase() === ('RV').toUpperCase() ? 7.1 : 14
    ...
    const backSubType = props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase() ? 15 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 7 : props.state.selectedTypeName.toUpperCase() === ('Trailer').toUpperCase() ? 16 : 17
    const transmissionNext = props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 14 : 11
    const transmissionPrev = props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 7 : 9
    const prevSeating = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 7 : 8
    const nextAccident = props.state.selectedTypeName.toUpperCase() === ('Trailer').toUpperCase() ? 18 : 17
    ...
    return (
        <React.Fragment>
                                ...
                                <div className='row align-items-center'>
                                    ...
                                    <div className='col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6'>
                                        <div className="SecSeven-Btn">
                                            ...
                                            // onClick={() => props.changeStepButton(18, 1, 2, props.state.startPercent)}
                                            >
                                                Next{" "}
                                                <i className="fa fa-angle-right"></i>
                                            </button>
                                ...
                                <React.Fragment key={index}>
                                    <div className="col-outer">
                                        <div className="grid-col">
                                            <div
                                                className={
                                                    props.state.previousAccident ==
                                                        item.value && props.state.previousAccident !== ""
                                ...
                                <React.Fragment key={index}>
                                    <div className="col-outer" key={index}>
                                        <div className="grid-col">
                                            <div
                                                className={
                                                    props.state.drivetrain == item.id
                                                        ? "VehicleChoose-Name active"
                                                        : "VehicleChoose-Name"
                                                }
                                                onClick={() =>
                ...
                <Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
                    <div className="AdPost-SecSeven item">
                        <div className="row">
                            ...
                            {props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? null : (
                                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div className="Kilometter-Form mb-0">
            ...
            {props.state.engineStepName !== '' && props.state.engineStepName !== undefined && props.state.newStep === true && props.state.step === 1.3 ? (
                <Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
                        ...
                        <div className="post-ad-tabular-filter-row EnginInput">
                            ...
                            <div className="form-group">
                                <input
                                    className="form-control"
                                    type="text"
                                    id={props.state.engineStepName === 'Engine Horsepower' ? 'engineCC' : ''}
                                    name={props.state.engineStepName === 'Engine Horsepower' ? 'engineCC' : ''}
                                    value={props.state.engineStepName === 'Engine Horsepower' ? props.state.engineCC : ''}
                                    onChange={props.handleOnChange}
                                    placeholder={props.state.engineStepName === 'Engine Horsepower' ? 'Enter Engine Horsepower' : ''}
                                />
                            </div>
            ...
            {props.state.newStepName !== '' && props.state.newStepName !== undefined && props.state.newStep === true && props.state.step === 1.2 ? (
                <Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
                    <div className="AdPost-SecFifteen vin-hin-section">
                        <div className="post-ad-tabular-filter-row">
                            ...
                            <p>{props.state.newStepName === 'VIN Number' ? 'A VIN is composed of 17 characters (digits and capital letters) that act as a unique identifier for the vehicle. The VIN can be found on the vehicle’s title, registration, or certificate of insurance.' : props.state.newStepName === 'HIN Number' ? 'The Hull Identification Number (HIN) is a 12- or 14-character serial number that uniquely identifies a boat. HIN can be found on the vehicle’s title, registration, or certificate of insurance.' : props.state.newStepName === 'Serial Number' ? 'Serial number is usually marked on the equipment it self.' : ''}  </p>
                        ...
                        <div className="row">
                            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div className="SecEight-DropMenu">
                                    ...
                                    />
                                    {/* <SelectSearch options={options} value={props.state.selectYear} name="selectYear" onChange={props.changeYear} closeOnSelect
                                        placeholder={null}
                                    /> */}
            ...
            {/* && props.state.selectedTypeName.toUpperCase() === ("BOAT").toUpperCase() */}
            {props.state.step === 4.1 ? (<>
                < Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
                                    ...
                                    <React.Fragment key={index}>
                                        ...
                                        <div className="col-outer">
                                            <div className="grid-col" key={index}>
                                                <div
                                                    className={
                                                        props.state.selectModel == item.id
                                                            ? "VehicleChoose-Name active"
                                                            : "VehicleChoose-Name"
                                                    }
                                                    onClick={() =>
            ...
            {
                props.state.step == 1.1 ? (
                    <>
                        {/* <Animated animationIn="fadeInUp" animationInDuration={100} animationOutDuration={100} animationOut="fadeOutUp" isVisible={true}></Animated> */}
                        <Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
                            <div className="AdPost-SecOne item" id="type_of_vehicles">
                                <h6>Select type of Powersport Vehicle:</h6>
                                <div className="boxed-grid-main clearfix">
                                    {/* {type_of_vehicle} */}
                                    {sub_type_of_vehicle}
                                    {/* Sub Type */}
            ...
            {/* && props.state.subVehicleType == '' */}
            {
                props.state.step == 1 ? (
                    // <Animated animationIn={props.state.lastStep > props.state.step ? 'fadeInDown' : "fadeInUp"} animationInDuration={1000} animationOutDuration={1000} animationOut="fadeOutUp" isVisible={true}>
                    <Animated animationIn={props.state.animation} animationInDuration={500} animationOutDuration={500} animationOut="fadeOutUp" isVisible={true}>
