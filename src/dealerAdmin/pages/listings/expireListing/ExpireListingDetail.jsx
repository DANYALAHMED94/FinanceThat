...
const mapStateToProps = (state) => {
    return {
        ...
        expire_listing_update: state.dealerAdminReducer.dealerListingReducer.expire_listing_update,
        loading_expir_listing_update: state.dealerAdminReducer.dealerListingReducer.loading_expir_listing_update,
