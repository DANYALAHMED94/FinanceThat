    ...
    <React.Fragment>
        ...
        <div className="Admin-DealerLeft">
          <div className="InnerDealer-Container">
            ...
            <div className="DealerID-Container">
              ...
              {/* <input type='text' name='province' value={state.province} onChange={handleOnChange} /> */}
              {props.accountType === "Dealer" ? (
                <div className="DealerID-List">
                  <div className="LeftCon">
                    <h1>Province</h1>
      ...
      {/* <div className="Reasonfor-Diclined dicline-add-mt">
                <div className="Reasonfor-Head">
                    ...
                    <textarea id="declineText" name="declineText" onChange={handleOnChange} value={state.declineText}> </textarea>
                </div>
            </div>
            ...
            <div className="Reasonfor-Btn">
                <button type="button" onClick={approvedAccount} disabled={props.loading_approved}>{props.loading_approved === true ? (<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>) : 'Approve'}</button>
                <button type="button" className="active" onClick={declineAccount} disabled={props.loading_decline}>{props.loading_decline === true ? (<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>) : 'Decline'}</button>
            </div> */}
    </React.Fragment>
  );
};
