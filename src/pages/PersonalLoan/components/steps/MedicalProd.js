...
import { medicalProcedure } from "../constant";
import { Formik, Form, Field } from "formik";
import { SelectInput } from "../formInputs";
import * as Yup from "yup";
export default function MedicalProd({ formState, setFormState, onContinue }) {
  ...
  return (
    ...
    <h1>Please select an option for Medical Procedure</h1>
    <Formik
      initialValues={{
