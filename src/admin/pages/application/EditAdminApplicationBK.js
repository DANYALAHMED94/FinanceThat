...
class EditAdminApplication extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      inComeFrequencies: [{ value: "Monthly", label: "Monthly" }, { value: "Weekly", label: "Weekly" }, { value: "Bi-Weekly", label: "Bi-Weekly" }],
       // Trade 
       trade_in: true,
        ...
        sellerLastName:
          this.props.application_detail !== undefined &&
            ...
            ? this.props.application_detail.seller !== undefined &&
              ...
              : ""
            : "",
            sellerName:this.props.application_detail !== undefined &&
            this.props.application_detail !== null
            ? this.props.application_detail.seller !== undefined &&
              this.props.application_detail.seller !== null
              ? this.props.application_detail.seller.first_name !== undefined &&
            ...
            <div className="side-bar-content">
              <div className="sidebar-head clearfix">
                ...
                <div className="row report-btn py-3">
                    ...
                    <div class="col-md-6 p-0">
                      {/* <Link to={this.state.coApplicantId ?'/admin/application/co-applicant-credit-report/' + this.state.coApplicantId : "#"} className={this.state.coApplicantId ? "btn btn-primary px-2" : "btn disable px-2"}>
