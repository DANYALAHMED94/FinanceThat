...
import InventoryApplicationV2 from "./../pages/InventoryApplicationV2/InventoryApplicationV2";
import { useLocation } from "react-router";
import { Link } from 'react-router-dom';
import { history } from '../_helpers';
import { toastr } from 'react-redux-toastr'
const ApplyNowInventory =()=> {
    ...
    <div className="applyNowMain">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="fs__bannerDescriptionWrapper">
              ...
              <div class="fs__btnWrapper" onClick={scrolldiv}>
                <Link  class="fs__btn">
                  Apply now
      ...
      <section class="section__getApprovedToday">
        <div class="section__container">
          ...
          <div class="module__getApprovedTodayWrap" id="formPage" style={{height:path === '/apply/12' ? "740px" : "690px"}}>
            <InventoryApplicationV2 />
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="fs__loanIntakeStepsMainWrap">
                  <h2>How to get Financing<br />from Finance That</h2>
                  ...
                  <div class="fs__btnWrapper" onClick={scrolldiv}>
                    <Link  class="fs__btn" style={{textDecoration:"none !important"}}>
                      Apply now
                      <span class="icon__arrow">
                        <img src="../assets/image/applyImgs/icon-long-arrow-white.svg" alt="" />
                      </span>
...
export default ApplyNowInventory