    ...
    addNewUser = () => {
        ...
        if (this.state.allPermissions === false) {
            upuser_id = [{
                ...
                "billing": (this.state.permissions || []).filter(item => (item.value === 'billing')).map(item => { return item.isChecked })[0],
                "dealership": (this.state.permissions || []).filter(item => (item.value === 'dealership')).map(item => { return item.isChecked })[0]
            }]
        ...
        this.props.create_new_user(data)
        console.log(data)
    }
            ...
            <div class="Admin-DealerLeft">
                ...
                <div class="InnerDealer-Container">
                    ...
                    <div class="InnerDealer-Head">
                        ...
                        <div class="InnerLeft"><h1>User Information</h1></div>
                    ...
                    <div class="DealerID-Container">
                        ...
                        <button type="button" class="mt-5" onClick={this.addNewUser}>Add User</button>
