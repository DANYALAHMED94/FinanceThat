...
import ApplicationCreditUnknown from "./SubmitApplication/ApplicationCreditUnknown";
import "../../assets/css/postAppFlow.css";
...
import ApplicantPreviousAddress from "./Applicant/ApplicantPreviousAddress";
import EmploymentPreviousInformation from "./Employment/EmploymentPreviousInformation";
import EmploymentPreviousInformation2 from "./Employment/EmploymentPreviousInformation2";
import CoApplicantPreviousAddress from "./CoApplicant/previous/CoApplicantPreviousAddress";
import CoApplicantPreviousAddress2 from "./CoApplicant/previous/CoApplicantPreviousAddress2";
import CoApplicantPreviousEmploymentInformation from "./CoApplicant/previous/CoApplicantPreviousEmploymentInformation";
import CoApplicantPreviousEmploymentAddress from "./CoApplicant/previous/CoApplicantPreviousEmploymentAddress";
import ApplicantPreviousAddress2 from "./Applicant/PreviousApplicantAddress2";
import DiscardModel from "../../components/alertMessages/DiscardModel";
...
class AddPostApplications extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      previousTypeOfEmployment: "Full Time",
      ...
      previousGrossIncome: "",
      previousCoEmploymentStatus: "Employed",
      previousCoTypeOfEmployment: "Full Time",
      ...
      selectedPreviousCoEmployerProvince: "",
      previousCoEmployerPhone: "",
      previousCoEmployerEmail: "",
      interestedVehicleType: "",
      selectInterestedVehicleSubType: "",
      interestedVehicleId: "",
      subIntrestedVehicleId: "",
      selectInterestedVehicleSubTypeName: "",
      postSteps: [
        {
      ...
      showAlert: true,
      subtypeOfVehicle: "",
      selectsubTypeOfVehicle: "",
      tradeIn: "no",
      looking_for_private_seller: "no",
      monthly_budget: "",
  ...
  changeEmployementInformation = (val) => {
    ...
    if (val === 1) {
      ...
      if (this.state.employmentStatus === "Retired") {
        if (!this.validator.fieldValid("Monthly Income")) {
      ...
      if (this.state.employmentStatus === "Self employed") {
        ...
        if (!this.validator.fieldValid("Employment Since Year")) {
          this.validator.showMessageFor("Employment Since Year");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Employment Since Month")) {
          this.validator.showMessageFor("Employment Since Month");
          this.forceUpdate();
          return false;
        }
    ...
    if (val === 3) {
      if (!this.validator.fieldValid("Previous Employement Status")) {
        this.validator.showMessageFor("Previous Employement Status");
        this.forceUpdate();
        return false;
      }
      if (this.state.previousEmploymentStatus === "Retired") {
        if (!this.validator.fieldValid("Previous Monthly Income")) {
          this.validator.showMessageFor("Previous Monthly Income");
          this.forceUpdate();
          return false;
        }
      }
      if (this.state.previousEmploymentStatus === "Self employed") {
        if (!this.validator.fieldValid("Previous Business Name")) {
          this.validator.showMessageFor("Previous Business Name");
          this.forceUpdate();
          return false;
        }

        if (!this.validator.fieldValid("Previous Employment Since Year")) {
          this.validator.showMessageFor("Previous Employment Since Year");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Employment Since Month")) {
          this.validator.showMessageFor("Previous Employment Since Month");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Business Type")) {
          this.validator.showMessageFor("Previous Business Type");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Monthly Income")) {
      ...
      if (
        this.state.previousEmploymentStatus !== "Unemployed" &&
        this.state.previousEmploymentStatus !== "Retired" &&
        this.state.previousEmploymentStatus !== "Self employed"
      ) {
        if (!this.validator.fieldValid("Previous Type Of Employee")) {
          this.validator.showMessageFor("Previous Type Of Employee");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Employer Name")) {
          this.validator.showMessageFor("Previous Employer Name");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Employer Occupation")) {
          this.validator.showMessageFor("Previous Employer Occupation");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Employment Since Year")) {
  ...
  changeCoEmploymentStep = (val) => {
    if (val > 0 && val < 2) {
      ...
      if (this.state.coEmploymentStatus === "Retired") {
        if (!this.validator.fieldValid("Co Applicant Monthly Income")) {
          this.validator.showMessageFor("Co Applicant Monthly Income");
          this.forceUpdate();
          return false;
        }
      }
      ...
      if (
        ...
        if (!this.validator.fieldValid("Co Applicant Employment Since Year")) {
          this.validator.showMessageFor("Co Applicant Employment Since Year");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Co Applicant Employment Since Month")) {
          this.validator.showMessageFor("Co Applicant Employment Since Month");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Co Applicant Monthly Income")) {
    ...
    if (val === 3) {
      if (
        !this.validator.fieldValid("Co Applicant Previous Employement Status")
      ) {
      ...
      if (this.state.coEmploymentStatus === "Retired") {
        if (
          !this.validator.fieldValid("Co Applicant Previous Monthly Income")
        ) {
          this.validator.showMessageFor("Co Applicant Previous Monthly Income");
          this.forceUpdate();
          return false;
        }
      }
      ...
      if (this.state.coEmploymentStatus === "Self employed") {
        if (!this.validator.fieldValid("Co Applicant Previous Business Name")) {
          this.validator.showMessageFor("Co Applicant Previous Business Name");
          this.forceUpdate();
          return false;
        }

        if (
          !this.validator.fieldValid("Co Applicant Previous Employment Since")
        ) {
          this.validator.showMessageFor(
            "Co Applicant Previous Employment Since"
          );
          this.forceUpdate();
          return false;
        }

        if (!this.validator.fieldValid("Co Applicant Previous Business Type")) {
          this.validator.showMessageFor("Co Applicant Previous Business Type");
          this.forceUpdate();
          return false;
        }
        if (
      ...
      if (
        ...
        if (
          !this.validator.fieldValid("Co Applicant Previous Type Of Employee")
        ) {
          this.validator.showMessageFor(
        ...
        if (!this.validator.fieldValid("Co Applicant Previous Employer Name")) {
          this.validator.showMessageFor("Co Applicant Previous Employer Name");
          this.forceUpdate();
          return false;
        }
        if (
        ...
        if (
          ...
          this.validator.showMessageFor(
            "Co Appli cant PreviousEmployment Since Year"
          );
          this.forceUpdate();
          return false;
        }
  ...
  changeStepButton = (prev, current, perc) => {
    ...
    if (prev === 1) {
      ...
      if (!this.validator.fieldValid("Salutation")) {
        this.validator.showMessageFor("Salutation");
        this.forceUpdate();
        return false;
      }
      if (
        !this.validator.fieldValid("Applicant Email By Dealer") &&
        userType == 2
      ) {
        this.validator.showMessageFor("Applicant Email By Dealer");
        this.forceUpdate();
        return false;
      }
      ...
      if (!this.validator.fieldValid("Applicant Telephone") && userType == 2) {
      ...
      if (!this.validator.fieldValid("Gender")) {
    ...
    if (prev === 2 && this.state.addressChild === 1) {
      ...
      if (this.state.durationAtAddress && this.state.durationAtAddress < 2) {
        this.setState({
          addressChild: 2,
        });
        return false;
    ...
    // previous address
    if (prev === 2 && this.state.addressChild === 3) {
      if (!this.validator.fieldValid("Duration At Previous Address")) {
        this.validator.showMessageFor("Duration At Previous Address");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Duration At Previous Address Month")) {
        this.validator.showMessageFor("Duration At Previous Address Month");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Previous Status")) {
        this.validator.showMessageFor("Previous Status");
        this.forceUpdate();
        return false;
      }
      ...
      if (
        this.state.previousStatus === "Owned" ||
        this.state.previousStatus === "Rent"
      ) {
        console.log("working in in");

        if (!this.validator.fieldValid("Previous Mortgage Amount")) {
          this.validator.showMessageFor("Previous Mortgage Amount");
          this.forceUpdate();
          return false;
        }
      }
    ...
    // step 3 if employee step 1
    if (prev === 3 && this.state.employeeInformationstep === 1) {
      if (!["Unemployed", "Retired"].includes(this.state.employmentStatus)) {
        if (!this.validator.fieldValid("Employer Street Address")) {
          this.validator.showMessageFor("Employer Street Address");
          this.forceUpdate();
      ...
      if (
        !this.validator.fieldValid("Co Applicant") &&
        this.state.employmentSinceYear >= 2
      ) {
    ...
    // step 3 if employee step 3
    if (prev === 3 && this.state.employeeInformationstep === 3) {
      if (
        !["Unemployed", "Retired"].includes(this.state.previousEmploymentStatus)
      ) {
        if (!this.validator.fieldValid("Previous Employer Street Address")) {
          this.validator.showMessageFor("Previous Employer Street Address");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Employer City")) {
          this.validator.showMessageFor("Previous Employer City");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Employer Province")) {
          this.validator.showMessageFor("Previous Employer Province");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Employer Phone")) {
    ...
    if (
      ...
      if (!this.validator.fieldValid("Co Monthly Income")) {
        this.validator.showMessageFor("Co Monthly Income");
        this.forceUpdate();
        return false;
      }
    }
    ...
    // when co-applicant employee step is 3
    if (prev === 4 && this.state.coEmploymentStep === 3) {
      if (
        !["Unemployed", "Retired"].includes(
          this.state.previousCoEmploymentStatus
        )
      ) {
        if (!this.validator.fieldValid("Previous Co Employer Street Address")) {
          this.validator.showMessageFor("Previous Co Employer Street Address");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Co Employer City")) {
          this.validator.showMessageFor("Previous Co Employer City");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Co Employer Province")) {
          this.validator.showMessageFor("Previous Co Employer Province");
          this.forceUpdate();
          return false;
        }
        if (!this.validator.fieldValid("Previous Co Employer Phone")) {
          this.validator.showMessageFor("Previous Co Employer Phone");
          this.forceUpdate();
          return false;
        }
      }
  ...
  changeAddress = (child, name, prev, perc) => {
    ...
    if (prev === 2 && this.state.addressChild === 2) {
      if (!this.validator.fieldValid("Previous Street Address")) {
        this.validator.showMessageFor("Previous Street Address");
        this.forceUpdate();
        return false;
      }

      if (!this.validator.fieldValid("Previous City")) {
        this.validator.showMessageFor("Previous City");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Previous Province")) {
        this.validator.showMessageFor("Previous Province");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Previous Postal Code")) {
        this.validator.showMessageFor("Previous Postal Code");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Applicant Previous Country")) {
        this.validator.showMessageFor("Applicant Previous Country");
        this.forceUpdate();
        return false;
      }
    }
  ...
  changeCoAddress = (child, name, prev, perc) => {
    ...
    if (
      ...
      if (this.state.coStatus === "Owned" || this.state.coStatus === "Rent") {
    ...
    if (prev === 3) {
      ...
      if (!this.validator.fieldValid("Co Previous Street Address")) {
        this.validator.showMessageFor("Co Previous Street Address");
        this.forceUpdate();
        return false;
      }

      if (!this.validator.fieldValid("Co Previous City")) {
        this.validator.showMessageFor("Co Previous City");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Co Previous Province")) {
        this.validator.showMessageFor(" CoPrevious Province");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Co Previous Postal Code")) {
        this.validator.showMessageFor("Co Previous Postal Code");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Co Applicant Previous Country")) {
        this.validator.showMessageFor("Co Applicant Previous Country");
        this.forceUpdate();
        return false;
      }
    }
  ...
  changeVehicleDetail = (e, perc) => {
    ...
    if (
      ...
      if (e === 1) {
        ...
        if ([7, 9, 6, 3].includes(+this.state.typeOfVehicle)) {
          if (!this.validator.fieldValid("Vehicle Sub Type")) {
            this.validator.showMessageFor("Vehicle Sub Type");
            this.forceUpdate();
            return false;
          }
        }
    ...
    if (tab !== "") {
      if (this.state.coApplication === "yes") {
        if (this.state.coApplicantStep === 1) {
          if (!this.validator.fieldValid("Co Salutation")) {
            this.validator.showMessageFor("Co Salutation");
            this.forceUpdate();
            return false;
          }
          ...
          if (!this.validator.fieldValid("Co Gender")) {
            this.validator.showMessageFor("Co Gender");
            this.forceUpdate();
            return false;
          }
        }
        if (
          this.state.coApplicantStep === 2 &&
          this.state.coApplicantAddressChild === 3
        ) {
          if (!this.validator.fieldValid("Co Duration At Previous Address")) {
            this.validator.showMessageFor("Co Duration At Previous Address");
            this.forceUpdate();
            return false;
          }
          if (
            !this.validator.fieldValid("Co Duration At Previous Address Month")
          ) {
            this.validator.showMessageFor(
          ...
          if (!this.validator.fieldValid("Co Previous Status")) {
            this.validator.showMessageFor("Co Previous Status");
            this.forceUpdate();
            return false;
          }
          if (
            ...
            if (!this.validator.fieldValid("Co Previous Mortgage Amount")) {
              this.validator.showMessageFor("Co Previous Mortgage Amount");
              this.forceUpdate();
              return false;
            }
          }
  ...
  updateSubmitPost = () => {
    ...
    if (this.state.sellerInfo === "no") {
      vehicle = {
        ...
        price: 0,
        condition: "",
        type_of_vehicle: this.state.interestedVehicleId,
        type_of_vehicle_name:
          this.props.type_of_vehicles?.filter(
            (item) => item.id == this.state.interestedVehicleId
          )?.[0]?.name || "",
        sub_type_of_vehicle: this.state.subIntrestedVehicleId,
        sub_type_of_vehicle_name:
          (this.state.selectInterestedVehicleSubType &&
            this.state.selectInterestedVehicleSubType.label) ||
          "",
        trade_in: this.state.tradeIn === "no" ? false : true,
      };
    }
    ...
    if (
      ...
      vehicle = {
        ...
        sub_type_of_vehicle: this.state.subtypeOfVehicle,
        type_of_vehicle_name:
          this.props.type_of_vehicles?.filter(
            (item) => item.id == this.state.typeOfVehicle
          )?.[0]?.name || "",
        sub_type_of_vehicle_name:
          this.props.type_of_vehicles
            ?.filter((item) => item.id == this.state.typeOfVehicle)?.[0]
            ?.typeofvehicle_id.filter(
              (ite) => ite.id == this.state.subtypeOfVehicle
            )?.[0]?.name || "",
        trade_in: this.state.tradeIn === "no" ? false : true,
      };
      seller = {
        ...
        first_name:
          this.state.sellerFirstName ||
          (this.state.sellerName || "").substring(
            0,
            (this.state.sellerName || "").indexOf(" ")
          ) ||
          "",
        last_name:
          this.state.sellerLastName ||
          (this.state.sellerName || "").substring(
            (this.state.sellerName || "").indexOf(" ") + 1
          ) ||
          "",
    ...
    let data = {
      ...
      street_address_2: this.state.applicantStreetAddress2,
      ...
      employment_since_year: this.state.employmentSinceYear,
      employment_since_month: this.state.employmentSinceMonth,
      gross_income:
    ...
    if (userType === 2) {
      data.dealer = this.props.user_id;
    }
    ...
    // adding seller detail from other source
      ...
      vehicle = {
        ...
        type_of_vehicle_name:
          (this.props.single_stock_detail &&
            this.props.single_stock_detail.length > 0 &&
            this.props.single_stock_detail[0]?.category &&
            this.props.single_stock_detail[0]?.category?.name) ||
          "",
        sub_type_of_vehicle:
          (this.props.single_stock_detail &&
            this.props.single_stock_detail.length > 0 &&
            this.props.single_stock_detail[0]?.sub_type_id &&
            this.props.single_stock_detail[0]?.sub_type_id?.id) ||
          "",
        sub_type_of_vehicle_name:
          (this.props.single_stock_detail &&
            this.props.single_stock_detail.length > 0 &&
            this.props.single_stock_detail[0]?.sub_type_id &&
            this.props.single_stock_detail[0]?.sub_type_id?.name) ||
          "",
        year:
          (this.props.single_stock_detail &&
            this.props.single_stock_detail.length > 0 &&
    ...
    if (this.state.coApplication === "yes") {
      data.co_applicant = {
        ...
        gender: this.state.coGender,
        salutation: this.state.coSalutation,
        ...
        street_address2: this.state.coApplicantStreetAddress2,
        ...
        employment_since_year: this.state.coEmploymentSinceYear,
        employment_since_month: this.state.coEmploymentSinceMonth,
        gross_income:
      ...
      // adding previous address and emplyer address
      // if its available in payload

      if (this.state.coDurationAtAddress < 2) {
        data.co_applicant.previous_applicant_address =
          previous_co_applicant_address;
      }
      if (this.state.coEmploymentSinceYear < 2) {
        data.co_applicant.previous_employer_address =
          previous_co_employer_address;
      }
    } else {
      data.co_applicant = {};
    }

    // addind vehical and seller info
    if (
      this.state.listingSource === "Vehicle listed on Finance That" &&
    ...
    data.looking_for_private_seller =
      this.state.looking_for_private_seller === "yes" ? true : false;
  ...
  submitPost = () => {
    ...
    const previous_applicant_address = {
      ...
      street_address_2: this.state.applicantPreviousStreetAddress2,
      city: this.state.previousCity,
      province: this.state.previousProvince,
      postal_code: this.state.previousPostalCode,
      duration_address_yr: this.state.durationAtPreviousAddress,
      duration_address_mn: this.state.durationAtPreviousAddressMonth,
      status: this.state.previousStatus,
      mortgage_amount: this.state.previousMortgageAmount,
    };
    // previous employer addresss and info
    const previous_employer_address = {
      employer_name: this.state.previousEmployerName,
      ...
      employer_telephone: this.state.previousEmployerPhone,
      employer_email: this.state.previousEmployerEmail,
      employement_status: this.state.previousEmploymentStatus,
      type_of_employment: this.state.previousTypeOfEmployment,
      employment_since_year: this.state.previousEmploymentSinceYear,
      employment_since_month: this.state.previousEmploymentSinceMonth,
      gross_income:
      ...
      business_name: this.state.previousEmployeeBusinessName,
      type_of_business: this.state.previousEmployeeTypeOfBusiness,
      occupation: this.state.previousOccupation,
    };
    // previous co applicant address
    const previous_co_applicant_address = {
      street_address: this.state.coApplicantPreviousStreetAddress,
      street_address_2: this.state.coApplicantPreviousStreetAddress2,
      city: this.state.coPreviousCity,
      province: this.state.coPreviousProvince,
      postal_code: this.state.coPreviousPostalCode,
      duration_address_yr: this.state.coDurationAtPreviousAddress,
      duration_address_mn: this.state.coDurationAtPreviousAddressMonth,
      status: this.state.coPreviousStatus,
      mortgage_amount: this.state.coPreviousMortgageAmount,
    };
    ...
    const previous_co_employer_address = {
      ...
      employment_since_year: this.state.previousCoEmploymentSinceYear,
      employment_since_month: this.state.previousCoEmploymentSinceMonth,
      occupation: this.state.previousCoOccupation,
      gross_income:
        this.state.previousCoGrossIncome == ""
          ? 0
          : this.state.previousCoGrossIncome
    ...
    let data = {
      ...
      country: this.state.applicantCountry,
      street_address: this.state.applicantStreetAddress,
      street_address2: this.state.applicantStreetAddress2,
      city: this.state.city,
      province: this.state.province,
      postal_code: this.state.postalCode,
      duration_address_yr: this.state.durationAtAddress,
      duration_address_mn: this.state.durationAtAddressMonth,
      status: this.state.status,
      business_name: this.state.employeeBusinessName,
      type_of_business: this.state.employeeTypeOfBusiness,
      mortgage_holder_name: "Remove From Design",
    ...
    console.log(data, "applicationPostDaata");
  };
  ...
  changeStepFinalize = (e, perc) => {
    if (e === 1 && this.state.sellerInfo === "no") {
      ...
      if (!this.validator.fieldValid("Monthly Budget")) {
        this.validator.showMessageFor("Monthly Budget");
        this.forceUpdate();
        return false;
      }
      if (!this.validator.fieldValid("Interested Vehicale Type")) {
        this.validator.showMessageFor("Interested Vehicale Type");
        this.forceUpdate();
        return false;
      }
      if ([7, 9, 6, 3].includes(+this.state.interestedVehicleId)) {
        if (!this.validator.fieldValid("Sub Type Of Vehicle")) {
          this.validator.showMessageFor("Sub Type Of Vehicle");
          this.forceUpdate();
          return false;
        }
      }
  ...
  changeInterestedVehicleType = (e, status) => {
    console.log(e, status);
    if (status) {
      this.setState({
        ...this.state,
        selectInterestedVehicleType: e,
        interestedVehicleType: e.label,
        interestedVehicleId: e.value,
        selectInterestedVehicleSubType: null,
        subIntrestedVehicleId: "",
        selectInterestedVehicleSubTypeName: "",
      });
    } else {
      this.setState({
        ...this.state,
        selectInterestedVehicleSubType: e,
        subIntrestedVehicleId: e.value,
        selectInterestedVehicleSubTypeName: e.label,
      });
    }
  };
    ...
    return (
      <React.Fragment>
        ...
        {/* <Beforeunload onBeforeunload={() => "You’ll lose your data!"}> */}
          ...
          +this.state.response_type === 11 ? (
            <ApplicationCreditUnknown
                          ...
                          <div className="ad-post-left-section">
                            <div className="SliderContainer">
                              ...
                              {this.state.currentTab === 0 ? (
                                ...
                                this.state.addressChild === 2 ? (
                                <>
                                  {/**Application Address */}
                                  <ApplicantPreviousAddress
                                    state={this.state}
                                    validator={this.validator}
                                    changeStepButton={this.changeStepButton}
                                    changeAddress={this.changeAddress}
                                    ...
                                    changeAddressChild={(val) =>
                                      this.setState({ addressChild: val })
                                    }
                                    changeSelect={this.changeSelect}
                                  />
                                </>
                              ) : this.state.currentTab === 2 &&
                                this.state.addressChild === 3 ? (
                                <>
                                  {/**Application Address */}
                                  <ApplicantPreviousAddress2
                                    state={this.state}
                                    validator={this.validator}
                                    changeStepButton={this.changeStepButton}
                                    changeAddress={this.changeAddress}
                                ...
                                this.state.employeeInformationstep === 2 ? (
                                <EmploymentPreviousInformation
                                  state={this.state}
                                  changeSelect={this.changeSelect}
                                  validator={this.validator}
                                  changeStepButton={this.changeStepButton}
                                ...
                                this.state.employeeInformationstep === 3 ? (
                                <EmploymentPreviousInformation2
                                  state={this.state}
                                  changeSelect={this.changeSelect}
                                  validator={this.validator}
                                  changeStepButton={this.changeStepButton}
                                ...
                                this.state.coApplicantStep === 2 &&
                                this.state.coApplicantAddressChild === 2 ? (
                                <>
                                ...
                                this.state.coApplicantStep === 3 &&
                                this.state.coEmploymentStep === 2 ? (
                                <>
                                  <CoApplicantPreviousEmploymentInformation
                                    state={this.state}
                                    changeSelect={this.changeSelect}
                                    validator={this.validator}
                                    changeStepButton={this.changeStepButton}
                                ...
                                this.state.coApplicantStep === 3 &&
                                this.state.coEmploymentStep === 3 ? (
                                <>
                                  <CoApplicantPreviousEmploymentAddress
                                    state={this.state}
                                    changeSelect={this.changeSelect}
                                    validator={this.validator}
                                    changeStepButton={this.changeStepButton}
                                ...
                                <>
                                  <FinalizeApplication
                                    ...
                                    changeInterestedVehicleType={
                                      this.changeInterestedVehicleType
                                    }
                                ...
                                <>
                                  <CompletePostEdit
                                    ...
                                    discardState={this.discardModel}
                                    vehicleDetailStep={
                                      this.state.vehicleDetailStep
                                    }
          ...
          {this.state.showDiscard && (
            <DiscardModel
              buttonAction={this.discardState}
              heading={"Discard Application"}
              section1={"Are you sure?"}
            />
          )}
        {/* </Beforeunload> */}
      </React.Fragment>
...
const mapStateToProps = (state) => {
  return {
    ...
    user_type: state.authReducer.authentication.user_type,
