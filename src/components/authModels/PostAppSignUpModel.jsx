...
const PostAppSignUpModel = (props) => {
  const [state, setState] = useState({
    first_name: props.applicantFirstName,
    firstNameError: false,
    last_name: props.applicantLastName,
    lastNameError: false,
    registerEmail: "",
                  ...
                  <div className="Modal-SignInForm">
                    ...
                    <div className="Modal-ByClicked">
                      <h1>
                        ...
                        <a href='/terms' target="_blank">Terms of Use</a> & <a href="/privacy" target='_blank'>Privacy Policy</a>
                      </h1>
                    </div>
                    ...
                    <div className="SignIn-SocialMedia">
                      {/* <div className="GooglePlus">
                        <img
                          src="/assets/image/sprite-icon/google-icon.svg"
                          alt=""
                        />
                      ...
                      <div className="Sign-Facebook">
                        <img
                          src="/assets/image/sprite-icon/facebook-icon.svg"
                          alt=""
                        />
...
export default PostAppSignUpModel;
