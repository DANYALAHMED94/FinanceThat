import { newPersonalLoanType } from "../constant";
import React from "react";
import { Formik, Form, Field } from "formik";
import { SelectInput } from "../formInputs";
import * as Yup from "yup";
export default function TypeOfLoanNew({ formState, setFormState, onContinue }) {
  ...
  return (
    ...
    <h1>Please select an option for personal loan</h1>
    <Formik
      initialValues={{
