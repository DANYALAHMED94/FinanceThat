...
const TypeofVehicle = (props) => {
    ...
    // const motorSelectNext = props.state.selectedTypeName.toUpperCase() === ('BOAT').toUpperCase() ? 9 : (props.state.selectedSubTypeName.toUpperCase() === ('Snowmobile').toUpperCase() || props.state.selectedSubTypeName.toUpperCase() === ('Watercraft').toUpperCase()) ? 15 : (props.state.engineStepName === 'Engine Horsepower' || props.state.engineStepName === 'Engine CC') ? props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 10 : props.state.selectedTypeName.toUpperCase() === ('Small Equipment').toUpperCase() ? 18 : 14 : props.state.selectedTypeName.toUpperCase() === ('RV').toUpperCase() ? 7.1 : props.state.selectedTypeName.toUpperCase() === ('TRAILER').toUpperCase() ? 14 : 8
    ...
    // const motorSelectPrev = (props.state.engineStepName === 'Engine Horsepower' || props.state.engineStepName === 'Engine CC') ? props.state.selectedSubTypeName.toUpperCase() === ('ATV/UTV').toUpperCase() ? 10 : 7 : props.state.selectedTypeName.toUpperCase() === ('Trailer').toUpperCase() ? 7 : 13
