...
const DealerOwners = (props) => {
  ...
  const { owners, dealer_id, loading_dealer_detail } = useSelector(
    ({ adminReducer }) => {
      return {
        owners: adminReducer.adminAccounts.pendingAccountReducer.owners,
    ...
    <React.Fragment>
      <div className="Altable-Container">
        <div className="Dealer-dtable">
          ...
          {/* <div className="col-12">
            <h5 className="lh-lg mt-3 mb-5">{selectedOwner + 1} Owner Information</h5>
            <hr></hr>
          </div> */}
          <div className="col-12">
