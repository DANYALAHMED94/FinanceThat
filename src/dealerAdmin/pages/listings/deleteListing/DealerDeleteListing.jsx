...
import DealerDeleteListingTable from "../../../component/listings/deleteListings/DealerDeleteListing";
import {
  get_listing,
...
class DealerDeleteListing extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tab: "dealer",
