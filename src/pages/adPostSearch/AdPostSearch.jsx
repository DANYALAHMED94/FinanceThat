...
import { VehicleTypeImages, SubVehicleTypeImages, SubVehicleConstruction } from "./VehicleImages/index.js";
...
class AdPostSearch extends PureComponent {
  ...
  componentDidMount() {
    ...
    const subType =
      this.state.subTypeOfVehicle !== ""
        ? this.state.type_of_vehicle.filter((item) =>Number(item.id) === Number(this.state.typeOfVehicle))[0]
        : "";
    const subTypeData =
  ...
  handleOnSelectMakeModel = (
    ...
    if (selectState === "selectedMakes" && this.state.allModels.length > 0) {
      this.setState({ allModels: [], selectedModel: [] });
    }
    // removing trims if there is no model selected
    if (selectState === "selectedModel" && this.state.allTrims.length > 0) {
                ...
                <div className="accordion" id="accordionExample">
                  {this.state.allowFilters.map((mainFilter, index) => (
                    <React.Fragment key={index}>
                      ...
                      {(Number(this.state.typeOfVehicle) === 9 || Number(this.state.typeOfVehicle) === 19) ? (
                        <div className="card">
                          <div className="card-header" id="headingTwo">
                            <h2 className="mb-0">
                              <button
                              ...
                              >
                                Type of {(this.state.type_of_vehicle|| []).filter(item=> Number(item.id) === Number(this.state.typeOfVehicle))?.[0]?.name || ""}
                              </button>
                            </h2>
                          </div>
                                    ...
                                    return (
                                      <React.Fragment key={index}>
                                        <div className="filters-inner-col">
                                          ...
                                          >
                                            <div className="vehicle-type-image">
                                             {Number(this.state.typeOfVehicle) === 9 ?SubVehicleTypeImages(subItem) : SubVehicleConstruction(subItem)}
                                            </div>
                                            <div className="vehicle-type-description">
                                              <strong>
                                                {subItem.name}
