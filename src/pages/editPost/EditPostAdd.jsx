...
class EditPostAdd extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevState.subTypeId !== this.state.subTypeId && this.state.subTypeId !== '' && this.state.subTypeId !== undefined) {
            let subTypeName = this.props.type_of_vehicles.filter(item => item.id == 9) ? this.props.type_of_vehicles.filter(item => item.id == 9)[0] ? this.props.type_of_vehicles.filter(item => item.id == 9)[0].typeofvehicle_id ? this.props.type_of_vehicles.filter(item => item.id == 9)[0].typeofvehicle_id.filter(item => Number(item.id) === Number(this.state.subTypeId)).map(item => { return item.name })[0] : '' : '' : ''
        ...
        if (prevProps.post_ad_detail_edit !== this.props.post_ad_detail_edit && this.props.post_ad_detail_edit !== undefined && this.props.post_ad_detail_edit.length > 0) {
            this.props.post_ad_detail_edit.map(item => {
                ...
                return this.setState({
                    ...
                    postCity: capitalize(item.city) !== undefined && capitalize(item.city) !== null ? capitalize(item.city) : '',
