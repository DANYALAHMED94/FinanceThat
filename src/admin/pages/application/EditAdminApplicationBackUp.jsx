...
class EditAdminApplication extends Component {
    constructor(props) {
        super(props)
        this.state = {
            buyerAppId: '',
            ...
            postApp: [{ id: 1, name: 'Applicant Details', active: true, done: false, disbaled: false, path: `${this.props.match.url}/applicant-detail` },
            ...
            //Upload Doc
            documents: [],
            adminDocumentRequest: [{ id: '', name: "Identifications", des: "Driver license, Passport etc..", isRequest: false, is_uploaded: false }, { id: '', name: "Utility Bill", des: "Final Invoice or bill of sale", isRequest: false, is_uploaded: false }, { id: '', name: "Void Cheque or PAD Form", des: "Final Invoice or bill of sale", isRequest: false, is_uploaded: false }, { id: '', name: "Bank Statement", des: "Final Invoice or bill of sale", isRequest: false, is_uploaded: false }, { id: '', name: "Paystub(s)", des: "Final Invoice or bill of sale", isRequest: false, is_uploaded: false }, { id: '', name: "Last Year Notice of Assessment", des: "Final Invoice or bill of sale", isRequest: false, is_uploaded: false }, { id: '', name: "5 Invoices Matching Deposits", des: "Final Invoice or bill of sale", isRequest: false, is_uploaded: false }, { id: '', name: "Last Year T4", des: "Final Invoice or bill of sale", isRequest: false, is_uploaded: false }, { id: '', name: "Letter of Employment", des: "Final Invoice or bill of sale", isRequest: false, is_uploaded: false }],
            documentsTable: [],
            deletedDocId: '',
            // Loan Doc
            loanDoc: null,
            ...
            applicantEmail: '',
            amortization: 120,
            amortizationValues: [{ label: '12 Months', value: 12 }, { label: '24 Months', value: 24 }, { label: '36 Months', value: 36 }, { label: '48 Months', value: 48 }, { label: '60 Months', value: 60 }, { label: '72 Months', value: 72 }, { label: '84 Months', value: 84 }, { label: '96 Months', value: 96 }, { label: '108 Months', value: 108 }, { label: '120 Months', value: 120 }],
            interestRate: 1,
    ...
    componentDidMount() {
        ...
        if (localStorage.getItem('coApplicantEditPostAppAdmin')) {
            coApplicant = Boolean(localStorage.getItem('coApplicantEditPostAppAdmin'))
        }
        this.setState({
            ...this.state,
            yearsDropDown: years,
    ...
    _handleloanDocChange(e) {
        ...
        if (file !== undefined && file !== null) {
            ...
            if (file != undefined && file != null && file !== '') {
                ...
                this.props.update_application_detail_file(formData, this.state.buyerAppId, 'adminLoanDocumentUpload')
            }
        }
    }
    deleteLoanDoc = () => {
    ...
    _handleUploadDocChange(e, fileIndex) {
        ...
        if (file !== undefined && file !== null) {
            ...
            if (filename != undefined && filename != null && filename.length > 0) {
                formData.append(filename[0].name, file)
                console.log(formData)
                this.props.update_application_detail_file(formData, this.state.buyerAppId, '')
            }
        }
    }
    deleteUploadDoc = (itemIndex, id) => {
        ...
        const docId = this.state.documents.filter((item, index) => Number(item.id) === Number(id)).map(item => { return item.id })[0]
        if (docId != undefined && docId != null && docId !== '') {
            ...
            this.setState({
                ...
                // this.state.documentsTable.slice().map((item, fileIndex) => {
                //     if (fileIndex === itemIndex) {
                //         return {
                //             ...item,
                //             file: null,
                ...
                //     return item
                // }),
                documentsTable: this.state.documentsTable.filter((item, fileIndex) => { return fileIndex !== itemIndex }),
                adminDocumentRequest: this.state.adminDocumentRequest.slice().map(item => {
    ...
    updateadminUploadDoc = (docIndex) => {
        this.setState({
            ...this.state,
            adminDocumentRequest: this.state.adminDocumentRequest.slice().map((item, index) => {
                if (index === docIndex) {
                    return {
                        ...item,
        ...
        const requiredFile = this.state.adminDocumentRequest.filter((item, index) => index === docIndex).map(itm => { return itm })[0]
        if (requiredFile != undefined && requiredFile != null && requiredFile !== '') {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.application_detail !== this.props.application_detail && this.props.application_detail !== undefined && Object.keys(this.props.application_detail) !== 0) {
            ...
            this.setState({
                ...
                adminDocumentRequest: this.props.application_detail != undefined && this.props.application_detail != null ? this.props.application_detail.required_documents != undefined && this.props.application_detail.required_documents != null ? this.state.adminDocumentRequest.slice().map(adminDoc => {
                    const exist = this.props.application_detail.required_documents.filter(uploadedDoc => uploadedDoc.name === adminDoc.name)
                    if (exist != undefined && exist != null && exist.length > 0) {
                        return {
                            ...adminDoc,
                            id: exist != undefined && exist != null && exist.length > 0 ? exist[0].id : '',
                            isRequest: true,
                            is_uploaded: exist != undefined && exist != null && exist.length > 0 ? exist[0].is_uploaded : false
                        }
                    } else {
                        return {
                            ...adminDoc,
        ...
        applicantEmail: this.props.application_detail.applicant_email_by_dealer,
                ...
                amortization: this.props.application_detail != undefined && this.props.application_detail != null ? this.props.application_detail.amortization != undefined && this.props.application_detail.amortization != null ? Number(this.props.application_detail.amortization) : 120 : 120,
                selectedAmortization: this.props.application_detail != undefined && this.props.application_detail != null ? this.props.application_detail.amortization != undefined && this.props.application_detail.amortization != null ? { label: `${this.props.application_detail.amortization} Months`, value: Number(this.props.application_detail.amortization) } : { label: '120 Months', value: 120 } : { label: '120 Months', value: 120 },
                interestRate: this.props.application_detail != undefined && this.props.application_detail != null ? this.props.application_detail.interest_rate != undefined && this.props.application_detail.interest_rate != null ? Number(this.props.application_detail.interest_rate) : 1 : 1,
                ...
                incomeVerification: this.props.application_detail != undefined && this.props.application_detail != null ? this.props.application_detail.income_verification != undefined && this.props.application_detail.income_verification != null ? this.props.application_detail.income_verification : '' : '',
            })
        ...
        if (prevProps.deleteUploadedDoc !== this.props.deleteUploadedDoc && this.props.deleteUploadedDoc !== undefined) {
            this.setState({
                ...
                documentsTable: this.state.documentsTable.filter((item, fileIndex) => { return Number(item.id) !== Number(this.state.deletedDocId) }),
        ...
        if (prevProps.agent_listing !== this.props.agent_listing && this.props.agent_listing !== undefined) {
            this.setState({
                ...this.state,
                allAgents: (this.props.agent_listing || []).map(item => {
                    return {
                        value: item.aud_user_id !== undefined && item.aud_user_id !== null && item.aud_user_id.length > 0 ? item.aud_user_id[0].user_id || '' : '',
                        label: item.aud_user_id !== undefined && item.aud_user_id !== null && item.aud_user_id.length > 0 ? item.aud_user_id[0].name || '' : ''
                    }
                })
            })
        }
        if (prevState.amortization !== this.state.amortization && this.state.amortization !== undefined) {
            let totalAmount = this.state.loan_amount !== undefined && this.state.loan_amount !== '' ? this.state.loan_amount : 0
            totalAmount = totalAmount.toString().split(',').join("").split('$').join('')
            var loan = Number(totalAmount).toFixed(2)
            var month = Number(this.state.amortization)
            let interestRate = this.state.interestRate !== undefined && this.state.interestRate !== '' ? this.state.interestRate : 1
            interestRate = this.state.interestRate.toString().split(',').join("").split('%').join('')
            var int = Number(interestRate).toFixed(2)
            var down = this.state.downPayment !== undefined && this.state.downPayment !== '' ? this.state.downPayment : 0
            ...
            const paymentType = this.state.paymentType === 'weekly' ? 52 : this.state.paymentType === 'bi-weekly' ? 26 : this.state.paymentType === 'monthly' ? 12 : 12
            var monInt = annInterest / paymentType
            var calculation = ((monInt + (monInt / (Math.pow((1 + monInt), months) - 1))) * (amount - (down || 0))).toFixed(2);
            console.log(monInt, paymentType, annInterest, down, months, amount, calculation)
            console.log(((monInt / (Math.pow((1 + monInt), months) - 1))), '(monInt + (monInt / (Math.pow((1 + monInt), months) - 1))) * (amount - (down || 0))')
            this.setState({
                ...this.state,
        ...
        if (prevState.paymentType !== this.state.paymentType && this.state.paymentType !== undefined) {
            let totalAmount = this.state.loan_amount !== undefined && this.state.loan_amount !== '' ? this.state.loan_amount : 0
            totalAmount = totalAmount.toString().split(',').join("").split('$').join('')
            var loan = Number(totalAmount).toFixed(2)
            var month = Number(this.state.amortization)
            ...
            var monInt = annInterest / paymentType
            var calculation = ((monInt + (monInt / (Math.pow((1 + monInt), months) - 1))) * (amount - (down || 0))).toFixed(2);
            calculation = this.state.amortization != undefined && this.state.amortization != null && this.state.amortization != '' ? calculation : 0
            this.setState({
                ...this.state,
                monthlyAmount: totalAmount == 0 ? 0 : calculation == 0 ? 0 : calculation,
            })
    ...
    render() {
        ...
        let lonaAmount = this.state.loan_amount !== undefined && this.state.loan_amount !== '' ? this.state.loan_amount : 0
                    ...
                    <div className="side-bar-content">
                        <div className="sidebar-head clearfix">
                            <div className="head-left">
                                ...
                                <Link to={'/admin/application/credit-report/' + this.state.buyerAppId} className="btn btn-primary"> Credit Report </Link>
                            </div>
                            <div className="head-right">
                                ...
                                ).format(Number(lonaAmount))// '$100.00'
                                ...
                                {/* <span className="monthly">  {this.state.monthlyAmount !== null && this.state.monthlyAmount !== '' ? new Intl.NumberFormat('en-US',
                                    ...
                                    : new Intl.NumberFormat('en-US',
                                        { style: 'currency', currency: 'USD' }
                                    ).format(0)} {this.state.paymentType === 'weekly' ? 'Weekly' : this.state.paymentType === 'bi-weekly' ? 'Bi-Weekly' : this.state.paymentType === 'monthly' ? 'Monthly' : 'Monthly'} </span> */}
                            </div>
                            <div className="application-status">
                                ...
                                {Number(this.state.applicationStatus) === Number('1') ? (
                                    <React.Fragment>
                                        ...
                                        <React.Fragment>
                                            <span className="status declinded"> Conditionally approved </span>
                                        </React.Fragment>) : Number(this.state.applicationStatus) === Number('3') ? (
                                            <React.Fragment>
                                                <span className="status declinded"> Pre-approved </span>
                                                ...
                                                <React.Fragment>
                                                    ...
                                                    <React.Fragment>
                                                        <span className="status declinded"> Approved </span>
                                                    </React.Fragment>) : (
                                    <React.Fragment>
                        ...
                        <div className="sidebar-nav-holder">
                            <ul className="nav-list">
                                {(this.state.postApp || []).map((item, index) => (
                                    <li className={item.active === true ? "nav-list-item active" : item.done === true ? "nav-list-item done" : "nav-list-item"} key={index} onClick={() => this.onClickChangeNav(item.id)}> <Link className="nav-link" to={item.path}> <span className="status-circle"> <i className="fa fa-check"></i> </span> {item.name} </Link> </li>
                                ))}

                            </ul>
                            <Link className="upload-document" to={`${this.props.match.url}/upload-doc`} onClick={() => this.onClickChangeNav(8)}> <span className="text-holder" onClick={this.removeLocalStorage}> Upload Documents </span> </Link>
                        </div>
                ...
                <Switch>
                    ...
                    <Route path={`${this.props.match.url}/assets-detail`}
                        ...
                        render={(props) => <AssetDetail handleOnChange={this.handleOnChange} {...this.state} {...this.props} changeSelectAssets={this.changeSelectAssets} handleOnChangeAssets={this.handleOnChangeAssets} addAssets={this.addAssets} deleteAsset={this.deleteAsset} changeSelectInfo={this.changeSelectInfo}
                            ...
                            addAddtionalInfor={this.addAddtionalInfor} changeSelect={this.changeSelect}
                    ...
                    <Route path={`${this.props.match.url}/verify-identity`}
                        ...
                        render={(props) => <VerifyIdentity  {...this.state} onClickChangeStep={this.onClickChangeStep} />} />
                    <Route path={`${this.props.match.url}/income-verify`}
                        exact
                        name="Income Verification"
                        render={(props) => <IncomeVerification  {...this.state} onClickChangeStep={this.onClickChangeStep} />} />
                    <Route path={`${this.props.match.url}/loan-payment`}
                        exact
                        name="Loan Payment Detail"
                        render={(props) => <LoanPaymentDetail  {...this.state} {...this.props} handleOnChangeDates={this.handleOnChangeDates} handleOnChange={this.handleOnChange} changePaymentType={this.changePaymentType} onClickChangeStep={this.onClickChangeStep} changeSelect={this.changeSelect} blurLoanAmount={this.blurLoanAmount} />} />
                    ...
                    <Route path={`${this.props.match.url}/upload-doc`}
                        exact
                        name="Upload Doc"
                        render={(props) => <UploadDoc  {...this.state} {...this.props} _handleImageChange={this._handleImageChange} updateadminUploadDoc={this.updateadminUploadDoc} deleteUploadedDoc={this.deleteUploadedDoc} deleteUploadDoc={this.deleteUploadDoc} />} />
                    <Route path={`${this.props.match.url}/assign-agent`}
                        exact
                        name="Assign Agent"
                        render={(props) => <AssignAgent  {...this.state} {...this.props} changeSelect={this.changeSelect} onClickChangeStep={this.onClickChangeStep} />} />
                </Switch>
            </div>
        </React.Fragment >)
    }
...
const mapStateToProps = (state) => {
    return {
        ...
        addtional_types: state.adminReducer.adminAccounts.applicationReducer.addtional_types,
        application_detail: state.adminReducer.adminAccounts.applicationReducer.application_detail,
        vehicle_makes: state.adminReducer.adminAccounts.applicationReducer.vehicle_makes,
        vehicle_models: state.adminReducer.adminAccounts.applicationReducer.vehicle_models,
        vehicle_trims: state.adminReducer.adminAccounts.applicationReducer.vehicle_trims,
        loading_update: state.adminReducer.adminAccounts.applicationReducer.loading_update,
        updateBuyerApplicationPersonal: state.adminReducer.adminAccounts.applicationReducer.updateBuyerApplicationPersonal,
        updateBuyerApplicationEmployement: state.adminReducer.adminAccounts.applicationReducer.updateBuyerApplicationEmployement,
        updateCoBuyerApplicationPersonal: state.adminReducer.adminAccounts.applicationReducer.updateCoBuyerApplicationPersonal,
        updateCoBuyerApplicationEmployement: state.adminReducer.adminAccounts.applicationReducer.updateCoBuyerApplicationEmployement,
        updateAssetsDetail: state.adminReducer.adminAccounts.applicationReducer.updateAssetsDetail,
        updateSellerDetail: state.adminReducer.adminAccounts.applicationReducer.updateSellerDetail,
        updateAddtionalInfo: state.adminReducer.adminAccounts.applicationReducer.updateAddtionalInfo,
        deleteAddtionalInfo: state.adminReducer.adminAccounts.applicationReducer.deleteAddtionalInfo,
        updateAssignAgent: state.adminReducer.adminAccounts.applicationReducer.updateAssignAgent,
        updateAdminLoanDocumentDetail: state.adminReducer.adminAccounts.applicationReducer.updateAdminLoanDocumentDetail,
        loading_delete_addtional: state.adminReducer.adminAccounts.applicationReducer.loading_delete_addtional,
        deleteVehicleDetail: state.adminReducer.adminAccounts.applicationReducer.deleteVehicleDetail,
        loading_delete_vehicle: state.adminReducer.adminAccounts.applicationReducer.loading_delete_vehicle,
        deleteUploadedDoc: state.adminReducer.adminAccounts.applicationReducer.deleteUploadedDoc,
        loading_delete_uploaded_doc: state.adminReducer.adminAccounts.applicationReducer.loading_delete_uploaded_doc,
        loadingFlinksRequestId: state.adminReducer.adminAccounts.applicationReducer.loadingFlinksRequestId,
        loadingFlinksLogin: state.adminReducer.adminAccounts.applicationReducer.loadingFlinksLogin,
        flinks_login_id: state.adminReducer.adminAccounts.applicationReducer.flinks_login_id,
        flinks_login_response: state.adminReducer.adminAccounts.applicationReducer.flinks_login_response,
        delete_doc_id: state.adminReducer.adminAccounts.applicationReducer.delete_doc_id,
        upload_doc_id: state.adminReducer.adminAccounts.applicationReducer.upload_doc_id,
