...
const SoldListingReviewLocation = props => {
    return (<React.Fragment>
        <div className="Admin-DealerAdres">
            ...
            />) : <h3>{props.listLocation.locationCity ? props.listLocation.locationCity : ''}{props.listLocation.locationCity && props.listLocation.locationProvince ? ',' : ''} {props.listLocation.locationProvince ? props.listLocation.locationProvince : ''}
...
export default SoldListingReviewLocation