...
const PrivateArchiveListing = (props) => {
  ...
  const componentRefArchiveDeleteListing = React.useRef(null);

  const checkPrivate = (id) => {
    props.single_check_listing(id, "private");
  };
  const toggleAllPrivate = () => {
    props.toggle_all_check_listing(!props.checkedAllPendingListing, "private");
  };
  const headers = [
  ...
  const delete_single_listing = (id) => {
    props.soft_delete_single_listing(id, "Search Archive Listing");
  };
  const delete_multiple_listing = () => {
    ...
    props.soft_delete_listings(ids, "Search Archive Listing");
  };
  const reactToPrintContent = React.useCallback(() => {
    return componentRefArchiveDeleteListing.current;
  }, [componentRefArchiveDeleteListing.current]);
    ...
    <React.Fragment>
      <div className="AlContainer">
        ...
        <div className="ActiveList-Right">
          ...
          >
            {props.loading_listing_delete === true ? (
      ...
      <div className="Altable-Container">
        <div className="Admin-dtable">
          ...
          <table
            style={{ width: "100%" }}
            id=""
            ref={componentRefArchiveDeleteListing}
          >
            <thead>
              <tr>
                <th>
                  <label className="ListCheckBox">
                    <input
                      type="checkbox"
                      checked={
                        props.checkedAllPendingListing !== undefined &&
                        props.checkedAllPendingListing !== null
                          ? props.checkedAllPendingListing
                          : false
                      }
                  ...
                  <div className="imgprint">
                    ...
                    >
                      <CSVLink
                        data={exportData}
                        headers={headers}
                        filename={"Pending_Private_Listings.csv"}
                      >
                        <img
                    ...
                    <ReactToPrint
                      documentTitle="Archive Listing Seller Record"
            ...
            <tbody>
              {(props.listing_detail || []).map((item, index) => (
                <tr key={index}>
                  ...
                  {/* <td><span><Link to={`${url}/${item.id}`}>{item.stock_id ? item.stock_id : ''}</Link></span></td> */}
                  <td>
                    <span>{item.stock_id ? item.stock_id : ""}</span>
                  </td>
                  <td>
                    <span>{`${item.year || ""}  ${
                      item.make !== undefined && item.make !== null
                  ...
                  {/* <td><span><Link to={`${url}/${item.id}`}>{`${item.year || ''}  ${item.make !== undefined && item.make !== null ? item.make.make_name !== undefined && item.make.make_name !== null ? item.make.make_name || '' : '' : ''}  ${item.model !== undefined && item.model !== null ? item.model.model_make !== undefined && item.model.model_make !== null ? item.model.model_make || '' : '' : ''}`}</Link></span></td> */}
                  <td>
                    <span>
                      {item.user_id !== undefined &&
                      item.user_id !== null &&
                  ...
                  <td style={{ width: "150px" }}>
                    ...
                    {/* <div className="admin-icon-delete"><button type="button" onClick={() => delet_single_listing(item.id)}>{props.loading_listing_delete_single && Number(item.id) === Number(props.delete_listing_id) ? (<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>) : <img src="/assets/image/sprite-icon/icon-delete.svg" alt="" />}</button></div> */}
...
export default PrivateArchiveListing;
