...
const DealerAdminNewApplication = (props) => {
    ...
    <React.Fragment>
      <div className="NewApp-Container">
          ...
          ? (props.dashboard_applications || []).map((item, index) => (
            <div className="Admin-ContentBox" key={index}>
              ...
              <div className="JhonDoe-Container mb-0">
                ...
                <div className="JhonHead-Right">
                  <Link to={`/dealer-admin/application/general/${item.id}`}>
                    Review
                  </Link>
        ...
        <div className="ViewAll-Btn">
          <Link to={`/dealer-admin/application/general`}>View all applications</Link>
        </div>
      </div>
    </React.Fragment>
  );
};
export default DealerAdminNewApplication;
