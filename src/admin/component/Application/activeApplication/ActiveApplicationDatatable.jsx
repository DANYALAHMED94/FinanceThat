...
const ActiveApplicationDatatable = (props) => {
  ...
  const delete_application = (id) => {
    props.delete_single_row(id, "Search Active Applications");
  };
  const delete_application_multi = () => {
    ...
    props.delete_multi_row(ids, "Search Active Applications");
  };
    ...
    <React.Fragment>
      ...
      <div className="admin-delete-selected-button">
        <button
          ...
          onClick={delete_application_multi}
...
export default ActiveApplicationDatatable;
