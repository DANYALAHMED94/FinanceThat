    ...
    return (
        <React.Fragment>
            ...
            {/* <div className="Account-EditBtn">
                {props.editListingImages === true ? (<button type="button" className="newbtn-add" disabled={!props.editListingImages} onClick={updateVehicleImages}> {props.update_listing_images === true ? (<i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i>) : null} Update</button>) : null}
