...
const AgentPreviews = (props) => {
  ...
  useEffect(() => {
    if (props.agent_detail !== undefined && props.agent_detail !== null) {
      (props.agent_detail || []).map((item) => {
        const permissions = [
          {
            value: "applications",
            name: "Applications",
          ...
          },
          {
            ...
            isChecked:
              item.upuser_id !== undefined &&
                item.upuser_id !== null &&
                item.upuser_id.length > 0
                ? item.upuser_id[0].agents !== undefined &&
                  item.upuser_id[0].agents !== null
                  ? item.upuser_id[0].agents
                  : false
                : false,
          },
          {
            ...
            isChecked:
              item.upuser_id !== undefined &&
                item.upuser_id !== null &&
                item.upuser_id.length > 0
                ? item.upuser_id[0].dms !== undefined &&
                  item.upuser_id[0].dms !== null
                  ? item.upuser_id[0].dms
                  : false
                : false,
          },
          // {
  ...
  const updatePermission = () => {
    const data = {
      ...
      //     return item.isChecked;
      //   })[0],
      agents: (state.permissions || [])
      .filter((item) => item.value === "agents")
      .map((item) => {
        return item.isChecked;
      })[0],
      dms: (state.permissions || [])
      .filter((item) => item.value === "dms")
      .map((item) => {
        return item.isChecked;
      })[0],
      id: state.id,
    ...
    console.log(data);
    props.update_agent_permissions(data);
  };
  ...
  const update_detail = () => {
    ...
    props.update_agent_detail(data)
  }
